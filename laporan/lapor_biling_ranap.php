...
$query = mysqli_query($mysqli, "SELECT * FROM tbl_daftarpasienranap AS u INNER JOIN tbl_transaksi_ranap AS i ON u.no_daftar = i.no_daftar INNER JOIN tbl_pegawai AS a ON u.id_peg = a.id_peg
