...
if (isset($_GET['tgl_awal'])) {
 $no    = 1;
   ...
   /* $query_tampil = "SELECT * FROM tbl_penjualan INNER JOIN tbl_pegawai ON tbl_penjualan.id_peg = tbl_pegawai.id_peg ORDER BY tbl_penjualan.tgl_penjualan DESC, tbl_penjualan.no_penjualan DESC";*/
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM tbl_daftarpasienranap INNER JOIN tbl_pegawai ON tbl_daftarpasienranap.id_peg = tbl_pegawai.id_peg  WHERE tbl_daftarpasienranap.tgl_daftar BETWEEN '$tgl_awal' AND '$tgl_akhir' AND asuransi_pas ='$asuransi'  
                                    ") 
...
<?php
    ...
    if($count == 0) {
        $no    = 0;
        $query2 = mysqli_query($mysqli, "SELECT * FROM tbl_daftarpasienranap INNER JOIN tbl_pegawai ON tbl_daftarpasienranap.id_peg = tbl_pegawai.id_peg  WHERE tbl_daftarpasienranap.tgl_daftar BETWEEN '$tgl_awal' AND '$tgl_akhir'   
                                    ") 
                                    or die('Ada kesalahan pada query tampil Transaksi : '.mysqli_error($mysqli));
        ...
        echo "  <tr>
                     <td width='20' height='13' align='center' valign='middle'>$no</td>
                        ...
                        <td style='padding-right:10px;' width='60' height='13' align='center' valign='middle'>$datang[asuransi_pas]</td>
                            <td style='padding-right:10px;' width='60' height='13' align='left' valign='middle'>$datang[diagnosa_awal]</td>
...
$nama       = $data['nama_peg'];
            ...
            echo "  <tr>
                        ...
                        <td style='padding-right:10px;' width='60' height='13' align='center' valign='middle'>$data[asuransi_pas]</td>
                            <td style='padding-right:10px;' width='60' height='13' align='left' valign='middle'>$data[diagnosa_awal]</td>
...
<?php
$filename="LAPORAN DATA PASIEN RANAP PER BULAN.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
