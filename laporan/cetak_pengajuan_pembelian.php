...
if (isset($_GET['tgl_awal'])) {
 ...
 $total = 0;
   ...
   /* $query_tampil = "SELECT * FROM tbl_penjualan INNER JOIN tbl_pegawai ON tbl_penjualan.id_peg = tbl_pegawai.id_peg ORDER BY tbl_penjualan.tgl_penjualan DESC, tbl_penjualan.no_penjualan DESC";*/
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM tbl_pengajuan INNER JOIN tbl_pegawai ON tbl_pengajuan.id_peg = tbl_pegawai.id_peg INNER JOIN tbl_pengajuan_pesan ON tbl_pengajuan.no_permintaan = tbl_pengajuan_pesan.no_permintaan 
INNER JOIN tbl_farmasi ON tbl_pengajuan.no_depo = tbl_farmasi.no_depo 
        INNER JOIN tbl_dataobat ON tbl_pengajuan_pesan.kd_obat = tbl_dataobat.kd_obat WHERE tbl_pengajuan.tgl_permintaan BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA DISTRIBUSI OBAT</title>
        <link rel="stylesheet" type="text/css" href="../../assets/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA DISTRIBUSI OBAT 
        </div>
    <?php  
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">DEPO </th>
                        <th height="20" align="center" valign="middle">PERMINTAAN KE</th>
...
<?php
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
         ...
         $sub = number_format($data['subtotal']);
...
$nama       = $data['nama_peg'];
            ...
            echo "  <tr>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>$data[no_permintaan]</td>
                        <td width='80' height='13' align='center' valign='middle'>$tanggal_masuk</td>
                        <td style='padding-left:5px;' width='100' height='13' valign='middle'>$data[nama_depo]</td>
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[request_unit]</td>
                        ...
                        <td style='padding-right:10px;' width='60' height='13' align='right' valign='middle'>$data[hrg_beli]</td>
...
?>	
 <tr>
                <th colspan="9" class="col_tot" align="center">Total</th>
...
<?php
$filename="LAPORAN DATA DISTRIBUSI OBAT.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
