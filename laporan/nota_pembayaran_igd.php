...
$hari_ini = date("d-m-Y");
   ...
   $query_daft = mysqli_query($mysqli,"SELECT * from tbl_daftarpasien_igd   WHERE no_daftar ='$no_daftar' ");
   ...
   /* $query_tampil = "SELECT * FROM tbl_penjualan INNER JOIN tbl_pegawai ON tbl_penjualan.id_peg = tbl_pegawai.id_peg ORDER BY tbl_penjualan.tgl_penjualan DESC, tbl_penjualan.no_penjualan DESC";*/
    // fungsi query untuk menampilkan data dari tabel obat masuk
       ...
       $query = mysqli_query($mysqli,"SELECT tbl_pengobatandetail.*, tbl_pengobatandetail.kd_obat, tbl_pengobatan.no_daftar, tbl_dataobat.kd_obat, tbl_dataobat.nm_obat, tbl_dataobat.hrg_obat FROM tbl_pengobatandetail
...
require_once "../config/database.php";
   ...
   $no    = 1;
       ...
       $query_lab = mysqli_query($mysqli,"SELECT tbl_hematologidetail.*, tbl_hematologidetail.kd_hematologi, tbl_hematologidetail.no_lab,   tbl_hematologi.no_daftar,tbl_hematologi.nm_dokter,  tbl_nama_hematologi.kd_hematologi, tbl_nama_hematologi.nama_hematologi, tbl_nama_hematologi.hrg_hematologi FROM tbl_hematologidetail
                ...
                WHERE no_daftar ='$no_daftar' ");
$counteri  = mysqli_num_rows($query_lab);
?>
            <table width="50%" border="0" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
...
$dokterlab       = $datalab['nm_dokter'];

                        $subtotal_lab   = $datalab['hrg_hematologi'];
    $totalTindakanlab = $totalTindakanlab + $subtotal_lab;
            // menampilkan isi tabel dari database ke tabel di aplikasi
            echo "  <tr>

                        <td style='padding-left:5px;' width='76' height='3' valign='middle'>$datalab[nama_hematologi]</td>
                            <td style='padding-right:10px;' width='50' height='3' align='right' valign='middle'>$datalab[hrg_hematologi]</td>
...
require_once "../config/database.php";
   ...
   $no    = 1;
       ...
       $query_trans = mysqli_query($mysqli,"SELECT * from tbl_transaksi_igd
                WHERE no_daftar ='$no_daftar' ");
...
?>
  ...
  <tr >
    ...
    <td colspan='2' style='padding-right:10px;' width='50' height='3' align='right' ><?php echo ($totalBayar+$totalRacik+$totalTindakan+$totalTindakanlab); ?></td>
</tr>
  <tr>
    <td colspan='1' style='padding-left:5px;' width='76' height='3' align='right'>Biaya Jasa Dokter  </td>
    <td colspan='2' style='padding-right:10px;' width='50' height='3' align='right' ><?php echo $jasa; ?></td>
</tr>
  ...
  <tr>
    <td colspan='1' style='padding-left:5px;' width='76' height='3' align='right'>Diskon  </td>
    <td colspan='2' style='padding-right:10px;' width='50' height='3' align='right' ><?php echo $diskon; ?></td>
</tr>
  <tr>
    <td colspan='1' style='padding-left:5px;' width='76' height='3' align='right'>Total Bayar  </td>
    <td colspan='2' style='padding-right:10px;' width='50' height='3' align='right' ><?php echo($totalBayar+$totalRacik+$totalTindakan+$totalTindakanlab+$admin+$jasa)-($diskon); ?></td>
</tr>
<tr>
...
<?php
$filename="lap Billing IGD.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
