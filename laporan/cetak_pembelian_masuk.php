...
if (isset($_GET['tgl_awal'])) {
 ...
 $total = 0;
   ...
   /* $query_tampil = "SELECT * FROM tbl_penjualan INNER JOIN tbl_pegawai ON tbl_penjualan.id_peg = tbl_pegawai.id_peg ORDER BY tbl_penjualan.tgl_penjualan DESC, tbl_penjualan.no_penjualan DESC";*/
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM tbl_pengajuan_pembelian INNER JOIN tbl_pegawai ON tbl_pengajuan_pembelian.id_peg = tbl_pegawai.id_peg INNER JOIN tbl_pengajuan_pesan_pembelian ON tbl_pengajuan_pembelian.no_faktur = tbl_pengajuan_pesan_pembelian.no_faktur 
INNER JOIN tbl_supplier ON tbl_pengajuan_pembelian.no_supplier = tbl_supplier.no_supp 
        INNER JOIN tbl_dataobat ON tbl_pengajuan_pesan_pembelian.kd_obat = tbl_dataobat.kd_obat WHERE tbl_pengajuan_pembelian.tgl_pembelian BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ") 
...
$nama       = $data['nama_peg'];
            ...
            echo "  <tr>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>$data[no_faktur]</td>
                        <td width='80' height='13' align='center' valign='middle'>$tanggal_masuk</td>
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[nama_supp]</td>
...
?>	
 <tr>
                <th colspan="8" class="col_tot" align="center">Total</th>
...
<?php
$filename="LAPORAN DATA PEMBELIAN OBAT.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
