			...
			<table class="tabel-datautama">
				<tr>
					<td class="kolom_utama">
						<?php 
							$query = "SELECT * FROM tbl_pengajuan_pembelian INNER JOIN tbl_pegawai ON tbl_pengajuan_pembelian.id_peg = tbl_pegawai.id_peg INNER JOIN tbl_supplier ON tbl_pengajuan_pembelian.no_supplier = tbl_supplier.no_supp WHERE tbl_pengajuan_pembelian.no_faktur = '$no_faktur'";
	...
	<?php } ?>
		...
		<div class="catatan">
			<table class="tabel-catatan">
				...
				<?php 
					if ($data_pbl['cr_bayar'] == "Pengajuan" && $data_pbl['status_byr'] == "Disetujui") {
				?>
				<tr>
