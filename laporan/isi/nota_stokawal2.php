<?php 
 ...
 ?>
<link type="text/css" href="./isi/style_css/nota_stokawal.css" rel="stylesheet">

<page backtop="15px">
	<page_header class="page_header">
		(Lampiran Apotek Padang Bulan Medan)
	</page_header>
			...
			<table class="tabel-datautama">
				<tr>
					...
					<td class="kolom_utama data_apotek">
						<span class="nama_apotek">APOTEK PADANG BULAN</span><br>
