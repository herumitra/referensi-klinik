...
$depo= $data[depo];*/
 ...
 echo '
    <div style="width:80%; border: 0px solid black; float:left; display: inline-block; margin-left:1% ; background:; cellspacing="0" ">
    <table  id="tabeletiket" width="80%"  style="font-size:8px;">
    <tr>
    <td colspan="2" align="center" style="font-weight:bold;">RUMAH SAKIT UMUM<br>Bagian Farmasi Rajal<br>Jl. R.S. Haji Medan</td>
    </tr>
    <tr>
    <td colspan="2"><hr></td>
    </tr>
    ...
    <td style="font-weight:bold;">: '.$noresep.'    &nbsp;&nbsp;          TTL : '.$lahir.'     </td>
    </tr>
    <tr>
    ...
    <tr>
    <td style="font-weight:bold;">Poli/Ruangan</td>
    <td style="font-weight:bold;">: '.$poli.'</td>
    </tr>
    <tr>
    <td style="font-weight:bold;">Nama Obat</td>
    <td style="font-weight:bold;">: '.$nm_obat.' &nbsp;  '.$jml.' '.$satuan.' </td>
    </tr>
    <tr>
    <td style="font-weight:bold;">Aturan Pakai</td>
    <td style="font-weight:bold;">: '.$akai.' </td>
    </tr>

    <tr>
    <td colspan="2" style="text-align:center; font-weight:bold;">Semoga Cepat Sembuh</td>
    </tr>
...
try
{
/*  $mpdf = new mPDF('utf-8',  array(100,50), 0, 0, 0, 0, 0, 0, 0);*/
    $html2pdf = new HTML2PDF('L','A8','fr', true, 'UTF-8', array(4, 3, 3, 2), false);
