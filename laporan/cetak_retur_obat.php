...
if (isset($_GET['tgl_awal'])) {
 ...
 $total = 0;
   ...
   /* $query_tampil = "SELECT * FROM tbl_penjualan INNER JOIN tbl_pegawai ON tbl_penjualan.id_peg = tbl_pegawai.id_peg ORDER BY tbl_penjualan.tgl_penjualan DESC, tbl_penjualan.no_penjualan DESC";*/
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM tbl_pengobatan INNER JOIN tbl_pegawai ON tbl_pengobatan.id_peg = tbl_pegawai.id_peg INNER JOIN tbl_pengobatan_retur ON tbl_pengobatan.no_pengobatan = tbl_pengobatan_retur.no_pengobatan 
INNER JOIN tbl_farmasi ON tbl_pengobatan.no_depo = tbl_farmasi.no_depo 
        INNER JOIN tbl_dataobat ON tbl_pengobatan_retur.kd_obat = tbl_dataobat.kd_obat WHERE  tbl_pengobatan.status_obat ='Retur' AND tbl_pengobatan.tgl_pengobatan BETWEEN '$tgl_awal' AND '$tgl_akhir'  
                                    ") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA RETUR OBAT</title>
        <link rel="stylesheet" type="text/css" href="../../assets/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA RETUR OBAT 
        </div>
    <?php  
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">RETUR KE DEPO </th>
                        <th height="20" align="center" valign="middle">REGISTRASI PASIEN</th>
...
$nama       = $data['nama_peg'];
            ...
            echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[no_daftar]</td>
...
<?php
$filename="LAPORAN DATA RETUR OBAT.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
