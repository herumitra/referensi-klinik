...
<page backtop="15px">
	<page_header class="page_header">
		(Lampiran Apotek Nabybani)
	</page_header>
	<page_footer>
	</page_footer>
	<div class="page-content">
		<div class="data-apotek">
			<span class="nama_apotek" style="font-weight: bold;">APOTEK Nabybani</span><br>
			Jl. Raya Samarang <br>
			(Telp) 0822-2775-50616
		</div>
		<div style="border-bottom: 1px solid; margin: 15px 0;"></div>
		<div class="judul-surat">
			<span class="judul">SURAT PENGAJUAN</span>
		</div>
		<div class="data-transaksi" style="line-height: 1.6; margin-bottom: 12px;">
			Dengan surat ini menyatakan bahwa transaksi :
			<?php 
				$query = "SELECT * FROM tbl_pengajuan INNER JOIN tbl_pegawai ON tbl_pengajuan.id_peg = tbl_pegawai.id_peg INNER JOIN tbl_supplier ON tbl_pengajuan.no_supplier = tbl_supplier.no_supp WHERE tbl_pengajuan.no_faktur = '$no_faktur'";
	...
	<?php 
		$no = 1;
		$total = 0;
		$query_lihat = "SELECT tbl_dataobat.nm_obat, tbl_pengajuandetail.hrg_beli, tbl_pengajuandetail.jml_beli, tbl_pengajuandetail.sat_beli, tbl_pengajuandetail.subtotal FROM tbl_pengajuandetail INNER JOIN tbl_dataobat ON tbl_pengajuandetail.kd_obat = tbl_dataobat.kd_obat WHERE tbl_pengajuandetail.no_faktur = '$no_faktur'";
...
<?php
$filename="LAPORAN PENGAJUAN.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
