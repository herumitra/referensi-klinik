...
<page backtop="15px">
	<page_header class="page_header">
		(Lampiran Apotek Padang Bulan)
	</page_header>
	<page_footer>
	</page_footer>
	<div class="page-content">
		<div class="data-apotek">
			<span class="nama_apotek" style="font-weight: bold;">APOTEK PADANG BULAN</span><br>
			Jl. Pasar VII Padang Bulan  <br>
			(Telp) 0822-2775-50616
		</div>
		...
		<div class="data-transaksi" style="line-height: 1.6; margin-bottom: 12px;">
			...
			<?php 
				$query = "SELECT * FROM tbl_stokawal INNER JOIN tbl_pegawai ON tbl_stokawal.id_peg = tbl_pegawai.id_peg INNER JOIN tbl_supplier ON tbl_stokawal.no_supplier = tbl_supplier.no_supp WHERE tbl_stokawal.no_faktur = '$no_faktur'";
			...
			<table class="data-nota">
				...
				<tr>
					<td>Tanggal</td>
					<td>: <?php echo tgl_indo($data_pbl['tgl_stokawal']); ?></td>
				</tr>
				<tr>
					<td>Supplier</td>
		...
		<table class="data-item data-item-stokawal" border="1">
			<tr>
	...
	<?php 
		$no = 1;
		$total = 0;
		$query_lihat = "SELECT tbl_dataobat.nm_obat, tbl_stokawaldetail.hrg_beli, tbl_stokawaldetail.jml_beli, tbl_stokawaldetail.sat_beli, tbl_stokawaldetail.subtotal FROM tbl_stokawaldetail INNER JOIN tbl_dataobat ON tbl_stokawaldetail.kd_obat = tbl_dataobat.kd_obat WHERE tbl_stokawaldetail.no_faktur = '$no_faktur'";
		...
		<div class="paraf">
			<table class="tabel-paraf">
				<tr>
					...
					<td class="keterangan-paraf kanan">Stok_awal</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="nama-paraf kanan">Apotek Padang Bulan</td>
				</tr>
			</table>
		</div>
	</div>
...
<?php
$filename="LAPORAN stokawal.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
