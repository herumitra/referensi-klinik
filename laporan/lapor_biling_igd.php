...
$query = mysqli_query($mysqli, "SELECT * FROM tbl_daftarpasien_igd AS u INNER JOIN tbl_transaksi_igd AS i ON u.no_daftar = i.no_daftar INNER JOIN tbl_pegawai AS a ON u.id_peg = a.id_peg
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN BILLING PASIEN IGD</title>
        <link rel="stylesheet" type="text/css" href="../asset/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN PENDAPATAN DARI PASIEN IGD 
        </div>
    <?php  
...
<?php
$filename="LAPORAN BILLING PASIEN IGD .pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
