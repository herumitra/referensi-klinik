...
<tr>
        ...
        <div class="data-transaksi" style="line-height: 1.2; margin-bottom: 8px;">
            ...
            <?php 
    $query2 = "Select * from tbl_daftarpasien where no_daftar='$no_daftar'";
...
<label><input type="checkbox" name='Laki-laki' value='Islam' <?php if($data['agama']=='Islam') echo 'checked="checked"'?>>ISLAM</label>
      ...
      <label><input type="checkbox" name='Belum Menikah' value='Belum Menikah' <?php if($datuk['status_nikah']=='Belum Menikah') echo 'checked="checked"'?>>BELUM MENIKAH</label>
                ...
                <tr>
                    <td></td>
                    <td>&nbsp; 
<label><input type="checkbox" name='Protestan' value='Protestan' <?php if($data['agama']=='Protestan') echo 'checked="checked"'?>>PROTESTAN</label>
      ...
      <label><input type="checkbox" name='Menikah' value='Menikah' <?php if($datuk['status_nikah']=='Menikah') echo 'checked="checked"'?>>MENIKAH</label>
                ...
                <tr>
                    <td></td>
                    <td>&nbsp; 
<label><input type="checkbox" name='Katolik' value='Katolik' <?php if($data['agama']=='Katolik') echo 'checked="checked"'?>>KATOLIK</label>
      ...
      <label><input type="checkbox" name='Janda' value='Janda' <?php if($datuk['status_nikah']=='Janda') echo 'checked="checked"'?>>JANDA</label>
                ...
                <tr>
                    <td></td>
                    <td>&nbsp; 
<label><input type="checkbox" name='Hindu' value='Hindu' <?php if($data['agama']=='Hindu') echo 'checked="checked"'?>>HINDU</label>
      ...
      <label><input type="checkbox" name='Duda' value='Duda' <?php if($datuk['status_nikah']=='Duda') echo 'checked="checked"'?>>DUDA</label>
                ...
                <tr>
                    <td></td>
                    <td>&nbsp; 
<label><input type="checkbox" name='Budha' value='Budha' <?php if($data['agama']=='Budha') echo 'checked="checked"'?>>BUDHA</label>
      ...
      <label><input type="checkbox" name='WNI' value='WNI' <?php if($datuk['negara']=='WNI') echo 'checked="checked"'?>>WNI</label>
                ...
                <tr>
                    <td></td>
                    <td>&nbsp; 
<label><input type="checkbox" name='Lain' value='Lain' <?php if($data['agama']=='Lain') echo 'checked="checked"'?>>LAIN....</label>
...
<tr>
                        <td style="width:150px; text-align: right;"></td>
                    <td>&nbsp;  
<label><input type="checkbox" name='IGD/PONEK' value='IGD/PONEK' <?php if($data['proses']=='IGD/PONEK') echo 'checked="checked"'?>>IGD / PONEK</label>
...
<?php
$filename="Surat Daftar Rajal.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
