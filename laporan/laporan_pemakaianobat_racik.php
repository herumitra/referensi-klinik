...
$total = 0;
   /* $query_tampil = "SELECT * FROM tbl_penjualan INNER JOIN tbl_pegawai ON tbl_penjualan.id_peg = tbl_pegawai.id_peg ORDER BY tbl_penjualan.tgl_penjualan DESC, tbl_penjualan.no_penjualan DESC";*/
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM tbl_racikan_pasien INNER JOIN  tbl_dataobat ON tbl_racikan_pasien.kd_obat = tbl_dataobat.kd_obat WHERE tbl_racikan_pasien.tgl_racik BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA PEMBERIAN OBAT RACIK</title>
        <link rel="stylesheet" type="text/css" href="../../assets/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA PEMBERIAN OBAT RACIK 
        </div>
    <?php  
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">RACIKAN</th>
...
<?php
 ...
 $subtotal = $data['hrg_jual']*$data['jumlah'];            
...
$nama       = $data['nama_peg'];
            ...
            echo "  <tr>
                        ...
                        <td style='padding-right:10px;' width='60' height='13' align='right' valign='middle'>$data[name]</td>
                        <td width='80' height='13' align='center' valign='middle'>$data[tgl_racik]</td>
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[nm_obat]</td>

                        <td width='40' height='13' align='center' valign='middle'>$data[jumlah]</td>
