...
if (isset($_GET['tgl_awal'])) {
 ...
 $total = 0;
   ...
   /* $query_tampil = "SELECT * FROM tbl_penjualan INNER JOIN tbl_pegawai ON tbl_penjualan.id_peg = tbl_pegawai.id_peg ORDER BY tbl_penjualan.tgl_penjualan DESC, tbl_penjualan.no_penjualan DESC";*/
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM tbl_stokawal INNER JOIN tbl_pegawai ON tbl_stokawal.id_peg = tbl_pegawai.id_peg INNER JOIN tbl_stokawaldetail ON tbl_stokawal.no_faktur = tbl_stokawaldetail.no_faktur INNER JOIN tbl_dataobat ON tbl_stokawaldetail.kd_obat = tbl_dataobat.kd_obat WHERE tbl_stokawal.tgl_stokawal BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA STOK AWAL OBAT</title>
        <link rel="stylesheet" type="text/css" href="../../assets/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA STOK AWAL OBAT 
        </div>
    <?php  
...
<?php
$filename="LAPORAN DATA STOKAWAL.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
