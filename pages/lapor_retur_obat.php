...
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Retur Obat</h4></div>
    <div class="col-6 text-right">
      <a href="?page=data_retur">
        <button class="btn btn-sm btn-info">Data Retur</button>
      </a>
    </div>
  </div>
...
?>
           ...
           <form role="form" class="form-horizontal" method="GET" action="laporan/cetak_retur_obat.php" target="_blank">
