...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item"><a href="?page=datapasien"><i class="fas fa-users"></i> Data Pasien</a></li>
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-user-edit"></i> Form Edit Data Pasien</li>
  </ol>
</nav>
			...
			<div class="col-md-6 offset-md-3 offset-form">
				...
				<form action="javascrip:void(0);">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <select name="pos_peg" id="pos_peg" class="form-control form-control-sm" <?php if($_SESSION['id_peg'] == $id_peg) { echo "disabled";} ?>>
				      	<option value="0">pilih posisi pasien</option>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <textarea name="indikasi_obat" id="alm_peg" rows="2" class="form-control" placeholder="masukkan alamat pasien" style="font-size: 14px;"><?php echo $data['alamat_peg'] ?></textarea>
				    </div>
				  </div>
				  <div class="form-group row">
...
<script>
	...
	$("#btn_simpan_edit").click(function() {
		...
		if(nama=="") {
			...
			Swal.fire(
			  'Data Belum Lengkap',
			  'maaf, tolong pilih posisi pasien',
			  'warning'
			)
		} else if (tgl_lahir=="") {
			...
			Swal.fire(
			  'Data Belum Lengkap',
			  'maaf, tolong isi nomor handphone pasien',
			  'warning'
			)
		} else if (username=="") {
			...
			Swal.fire(
			  'Data Belum Lengkap',
			  'maaf, tolong isi username pasien',
			  'warning'
			)
		} else if (password=="") {
			...
			Swal.fire(
			  'Data Belum Lengkap',
			  'maaf, tolong isi password pasien',
			  'warning'
			)
		} else {
			Swal.fire({
	          title: 'Apakah Anda Yakin?',
	          text: 'anda akan merubah data pasien',
	          type: 'warning',
	            ...
	            $.ajax({
	              ...
	              success: function(hasil) {
	              	if(hasil=="gagal-username") {
						...
						Swal.fire(
						  'Peringatan',
						  'Username Telah Digunakan, Ganti Username Pasien',
						  'warning'
						)
