		...
		<div class="row">
			<div class="col-md-6 offset-md-3 offset-form">
				...
				<form action="javascrip:void(0);">
				  ...
				  <div class="form-group row">
				    <label for="pos_peg" class="col-sm-3 col-form-label">Poli / Ruangan</label>
				    <div class="col-sm-9">
<select name="poli" id="poli" class="form-control form-control-sm" >

                <?php
                //query menampilkan nama unit kerja ke dalam combobox
                $query    =mysqli_query($conn, "SELECT * FROM tbl_poli");
                while ($dataku = mysqli_fetch_array($query)) {
                ?>
                <option value="<?=$dataku['nama_poli'];?>"><?php echo $dataku['nama_poli'];?></option>
                <?php } ?>
			      </select>
	...
	$("#btn_simpan").click(function() {
		...
		if(nama=="" || cek_nama) {
			...
			$.ajax({
				...
				data: "nama="+nama+"&poli="+poli+"&posisi="+posisi+"&tgl_lahir="+tgl_lahir+"&alamat="+alamat+"&username="+username+"&password="+password+"&jk="+jk+"&no_hp="+no_hp,
