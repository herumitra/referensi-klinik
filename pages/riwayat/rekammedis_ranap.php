            ...
            <div class="col-md-12 vertical-form">
                    ...
                    <div class="row data-pengobatan">
                        <div class="position-relative form-group col-md-3">
                            <label for="no_daftar" class="">Nomor Registrasi </label>
...
$totel = 0;
     $totel_bayar = 0;
                ...
                $tgl_sekarang = date('Y-m-d');
                $nomor = 1;
                $query_pjlobat = "SELECT * From tbl_racikan_pasien WHERE no_daftar ='$no_daftar' ";
                $sql_pjlobat = mysqli_query($conn, $query_pjlobat) or die ($conn->error);
             ?>
            <tbody>
            <?php  
...
$totel = $data_pjlobat['jumlah'] *$data_pjlobat['hrg_jual'];
      ...
      $totel_bayar += $totel;
            ?>
                <tr>
                    <td><?php echo $nomor++; ?></td>
                    <td><?php echo $data_pjlobat['no_daftar']; ?></td>
                    <td><?php echo $data_pjlobat['name']; ?></td>
                    <td><?php echo $data_pjlobat['nm_obat']; ?></td>
                    <td><?php echo $data_pjlobat['jumlah']; ?></td>
                    <td><?php echo $data_pjlobat['hrg_jual']; ?></td>
