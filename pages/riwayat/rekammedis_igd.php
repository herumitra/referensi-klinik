...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Rekam Medis Pasien IGD</h4></div>
        <div class="col-6 text-right">
            <a href="?page=riwayatmedis_igd">
...
<div class="form-container">
        <div class="row" style="padding: 0 16px;">
            <div class="col-md-12 vertical-form">
                  ...
                  <?php 
                    $query_tampil = "SELECT * FROM tbl_daftarpasien_igd WHERE nomor_rm='$nomor_rm'";
 ...
 <h5><i class="fas fa-list-alt"></i> Riwayat Kunjungan Berobat Pasien</h5>
        ...
        <?php 
    $nomor_rm = @$_GET['id'];        
            $query_tampil = "SELECT * FROM tbl_daftarpasien_igd  WHERE nomor_rm ='$nomor_rm' ORDER BY tgl_daftar asC"  ;
            $sql_tampil = mysqli_query($conn, $query_tampil) or die ($conn->error);
