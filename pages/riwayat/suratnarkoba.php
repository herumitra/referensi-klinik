...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Form Nomor Surat Narkoba</h4></div>
        ...
        $tahun = date ('Y');
        $nomor = "/SK-BN/".$romawi."/".$tahun;
        
        // membaca kode / nilai tertinggi dari penomoran yang ada didatabase berdasarkan tanggal
        $hasil = mysqli_query($conn,"SELECT max(no_surat) as maxKode FROM tbl_suratnarkoba WHERE month(tgl_surat)='$bulan'") or die (mysql_error());
            ...
            <div class="col-md-10 offset-md-1 offset-form">
                  ...
                  <div class="form-group row pt-3">
                    ...
                    <div class="col-sm-9">
                            ...
                            <input name="no_surat" id="no_surat" placeholder="nomor surat" type="text" class="form-control form-control-sm" value="<?php echo $nomorbaru; ?>">
...
<!-- 
 ...
 <h5 align="center"> Surat Narkoba</h5>
    ...
    $no_daftar = @$_GET['id'];
                ...
                $nomor = 1;
                $query_pjlobat = "SELECT * From tbl_suratnarkoba
