...
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Pasien Per Bulan IGD</h4></div>
    <div class="col-6 text-right">
      <a href="?page=datapasien">
        <button class="btn btn-sm btn-info">Data Pasien IGD</button>
      </a>
    </div>
  </div>
...
?>
 ...
 <form role="form" class="form-horizontal" method="GET" action="laporan/cetakpasien_igd.php" target="_blank">
