...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Form Nomor Surat Sehat</h4></div>
        ...
        $hasil = mysqli_query($conn,"SELECT max(no_surat) as maxKode FROM tbl_suratsehat WHERE month(tgl_surat)='$bulan'") or die (mysql_error());
...
<!-- 
 ...
 <h5 align="center"> Surat Sehat</h5>
    ...
    $no_daftar = @$_GET['id'];
                ...
                $nomor = 1;
                $query_pjlobat = "SELECT * From tbl_suratsehat
