...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Form Nomor Surat Sakit</h4></div>
        ...
        $tahun = date ('Y');
        $nomor = "/SKSK/KA/".$romawi."/".$tahun;
        
        // membaca kode / nilai tertinggi dari penomoran yang ada didatabase berdasarkan tanggal
        $hasil = mysqli_query($conn,"SELECT max(no_surat) as maxKode FROM tbl_suratsakit WHERE month(tgl_surat)='$bulan'") or die (mysql_error());
 ...
 <div class="form-group row">
                    <label for="nomor_rm" class="col-sm-2 col-form-label">Tgl Mulai Istirahat</label>
                    <div class="col-sm-4">
                    <div class="input-group-append">
                     <input type="date" class="form-control form-control-sm" id="tgl_istirahat" value="<?php echo $data['tgl_istirahat'] ?>">
                    </div>
                    </div>
                    <label for="nomor_rm" class="col-sm-2 col-form-label" style="text-align: right;">Sampai Dengan </label>
                    <div class="col-sm-4">
                      <input type="date" class="form-control form-control-sm" id="tgl_selesai" value="<?php echo $data['tgl_selesai'] ?>">
                      <small class="form-text text-muted" style="text-align: right;">bulan/tanggal/tahun</small>
                    </div>
                  </div>
 ...
 <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control form-control-sm" name = "kebutuhan" id="kebutuhan" placeholder="masukkan keluhan" autofocus="" value="">
...
<!-- 
 ...
 <h5 align="center"> Surat Sakit</h5>
    ...
    $no_daftar = @$_GET['id'];
                ...
                $nomor = 1;
                $query_pjlobat = "SELECT * From tbl_suratsakit
    ...
    $("#btn_simpan").click(function() {
        ...
        if(nama_pas=="") {
            ...
            $.ajax({
                ...
                data: "no_surat="+no_surat+"&tgl_surat="+tgl_surat+"&kebutuhan="+kebutuhan+"&no_daftar="+no_daftar+"&nm_dokter="+nm_dokter+"&nama_pas="+nama_pas+"&nomor_rm="+nomor_rm+"&tgl_lahir="+tgl_lahir+"&tgl_istirahat="+tgl_istirahat+"&tgl_selesai="+tgl_selesai,
