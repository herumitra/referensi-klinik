<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-briefcase-medical"></i> Data Poli</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6" id="judul"><h4>Data Poli</h4></div>
		<div class="col-6 text-right">
  <a href="?page=tambah_datapoli">
	...
	<div class="table-container">
		...
		<?php 
/*			$no = 1;*/
			$query_tampil = "SELECT * FROM tbl_poliklinik";
		 ...
		 ?>
		 		<tr>
		 			...
		 			<td class="td-opsi">
                        <button class="btn-transition btn btn-outline-primary btn-sm" title="edit" id="tombol_edit" name="tombol_edit" data-id="<?php echo $data['id_poli']; ?>">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn-transition btn btn-outline-danger btn-sm" title="hapus" id="tombol_hapus" name="tombol_hapus" data-id="<?php echo $data['id_poli']; ?>" data-nama="<?php echo $data['nama_poli']; ?>">
...
<script>
	...
	$("button[name='tombol_edit']").click(function() {
		var id = $(this).data('id');
		window.location='?page=edit_datapoli&id='+id;
	});
