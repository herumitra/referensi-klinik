<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item"><a href="?page=datastokawal"><i class="fas fa-shopping-bag"></i> Data stokawal</a></li>
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-file"></i> Form Laporan stokawal</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Form Laporan stokawal</h4></div>
	...
	<div class="form-container">
		<div class="row">
			<div class="col-md-6 offset-md-3 offset-form">
				<h6><i class="fas fa-list-alt"></i> Lengkapi form ini untuk mencetak laporan stokawal</h6>
					<form action="" method="POST" target="blank" id="form_laporanstokawal">
...
<script>
	...
	function cetak(action) {
		var form_data = $("#form_laporanstokawal").serialize();
		$.ajax({
			url: 'ajax/cek_laporin.php?page=laporan_stokawal',
			method: 'POST',
			data: form_data,
			success:function(data) {
				if(data=="kosong") {
	                Swal.fire({
	                  title: 'Kosong',
	                  text: 'maaf, tidak ditemukan data stokawal dengan kriteria tersebut',
	                  type: 'error',
	            	...
	            	var form = document.getElementById("form_laporanstokawal");
					form.action = action;
					form.submit();
	            }
            }
	...
	$("#tbl_cetakdetail").click(function() {
		 cetak('laporan/?page=laporan_stokawal_detail');
	});

	$("#tbl_cetakrangkuman").click(function() {
		cetak('laporan/?page=laporan_stokawal_rangkuman');
	});
</script>