...
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Stok Awal</h4></div>
    <div class="col-6 text-right">
      <a href="?page=datastokawal">
        <button class="btn btn-sm btn-info">Data Stok Awal</button>
      </a>
    </div>
  </div>
...
?>
           ...
           <form role="form" class="form-horizontal" method="GET" action="laporan/cetak_stokopname.php" target="_blank">
