<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Entry Data stokawal</li>
  </ol>
</nav>

<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Form Entry Data stokawal</h4></div>
		<div class="col-6 text-right">
			<a href="?page=datastokawal">
				<button class="btn btn-sm btn-info">Data stokawal</button>
			</a>

            <a href="?page=laporstokawal">
	...
	<div class="form-container">
		<div class="row" style="padding: 0 16px;">
			<div class="col-md-12 vertical-form">
				<h6><i class="fas fa-list-alt"></i> Lengkapi form ini untuk menambah data stokawal</h6>
                <form method="post" id="form-stokawal" autocomplete="off">
                    <div class="row data-stokawal">
                        ...
                        <div class="position-relative form-group col-md-4">
                            <label for="tgl_stokawal" class="">Periode stokawal</label>
                            <div class="input-group date">
                                <input type="text" class="form-control form-control-sm datepicker" id="tgl_stokawal" name="tgl_stokawal">
                            ...
                            <table class="table display tabel-data">
                                ...
                                <tfoot>
                                    ...
                                    <tr class="baris_total" style="display: none;">
                                        <td colspan="6" class="text-right" style="font-weight: bold;">Total : <span id="total_stokawal"></span><input type="hidden" name="hidden_totalstokawal" id="hidden_totalstokawal"></td>
                                        <td class="td-opsi">
                    ...
                    <div class="row tombol-kanan">
                        <div class="col-md-7 data-stokawal row">
                            <div class="position-relative form-group col-md-4">
                        ...
                        <div class="col-md-5 text-right simpan_stokawal">
                            <input type="submit" name="simpan_stokawal" id="simpan_stokawal" class="btn btn-info" value="Simpan">
                        </div>
                    </div>
                </form>
			</div>
...
$(document).ready(function() {
    ...
    $("#tambah_obat").click(function() {
        ...
        if(kode == ""){
            ...
            $("#total_stokawal").text(total_pembayaran);
            $("#hidden_totalstokawal").val(total_pembayaran);
    ...
    $("#simpan_stokawal").click(function () {
        event.preventDefault();
        // var str = $("#form-stokawal").serialize();
        // alert(str);
        var no_faktur = $("#no_faktur").val();
        var no_supp = $("#no_supplier").val();
        var tgl_pbl = $("#tgl_stokawal").val();
        ...
        if(no_faktur=="") {
            ...
            document.getElementById("tgl_stokawal").focus();
            Swal.fire(
              'Data Belum Lengkap',
              'maaf, tolong isi periode stokawal',
              'warning'
            )
            ...
            Swal.fire({
              title: 'Simpan ?',
              text: 'apakah anda telah mengisi data stokawal dengan benar ',
              type: 'warning',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
              ...
              if (simpan.value) {
                ...
                if(count_data > 0) {
                    var form_data = $("#form-stokawal").serialize();
                    $.ajax({
                        url: "ajax/simpan_stokawal.php",
                        method: "POST",
                        data: form_data,
                        success:function(data) {
                            Swal.fire({
                              ...
                              if (ok.value) {
                                // window.location='?page=entry_datastokawal';
                                if(cr_byr=="Langsung") {
