  ...
  <form method="post" id="form_hematologi" autocomplete="off">
                    ...
                    <div class="row data-pengobatan">
                        <div class="position-relative form-group col-md-4">
                            <label for="no_daftar" class="">Kode Hematologi</label>
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control form-control-sm" id="kd_hematologi" name="kd_hematologi" value="<?php echo $kd_hematologi; ?>" >
...
<!--  $query_tampil = "SELECT * FROM tbl_nama_hematologi  WHERE status = 'aktif' ORDER BY nama_hematologi ASC";
 -->
                  <?php 
                    ...
                    $query_tampil = "SELECT * FROM tbl_nama_hematologi WHERE kd_hematologi='$kd_hematologi'";
                    $sql_tampil = mysqli_query($conn, $query_tampil) or die ($conn->error);
                   ...
                   ?>
                        ...
                        <div class="position-relative form-group col-md-4">
                            <label for="nama_pas" class="">Nama Hematologi</label>
                            <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" id="nama_hematologi" name="nama_hematologi" placeholder="masukkan nama pasien" autofocus="" value="<?php echo $data['nama_hematologi']; ?>" disabled="">
                                </div>
  ...
  <div class="position-relative form-group col-md-4">
     <label for="nama_hematologi" class="">Harga Hematologi</label>
                            <div class="input-group">
                                    <input type="number" class="form-control form-control-sm" id="hrg_hematologi" name="hrg_hematologi" placeholder="masukkan  hematologi" autofocus="" value="<?php echo $data['hrg_hematologi']; ?>" >
                                </div>
</div>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Data Hematologi</h5>
 ...
 <script>  
    $(document).ready(function(){  
      $('#editable_table').Tabledit({
        url:'pages/js/action_hematologi.php',
        columns:{
          identifier:[0, "no"],
          editable:[[3, 'satuan'], [4, 'nilai_normal']]
        },
        restoreButton:true,
