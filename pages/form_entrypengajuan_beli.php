...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Form Entry Data Pengajuan Pembelian Obat</h4></div>
		<div class="col-6 text-right">
			<a href="?page=datapengajuan">
				<button class="btn btn-sm btn-info">Data Pembelian</button>
			</a>

            <a href="?page=laporpembelian">
                <button class="btn btn-sm btn-warning">Laporan Pembelian Obat</button>
            </a>
		</div>
	</div>
...
$(document).ready(function() {
    ...
    $("#simpan_pembelian").click(function () {
        ...
        } else if(cr_byr=="Pengajuan" && jth_tempo=="") {
            ...
            Swal.fire({
              ...
              if (simpan.value) {
                ...
                if(count_data > 0) {
                    ...
                    $.ajax({
                        url: "ajax/simpan_pengajuan_pembelian.php",
                        method: "POST",
                        data: form_data,
