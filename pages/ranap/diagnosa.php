...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Form Diagnosa Pasien</h4></div>
 ...
 <div class="form-group row">
				    ...
				    <div class="col-sm-4">
				      ...
				      <input type="text" class="form-control form-control-sm" id="code" name="code" placeholder="masukkan Code" autofocus="" value="">
				    ...
				    <div class="col-sm-4">
					<input type="text" class="form-control form-control-sm" name="diagnosa" id="diagnosa" placeholder="masukkan diagnosa" autofocus="" value="">
					</div>
				  </div>
 ...
 <div class="form-group row">
				    ...
				    <div class="col-sm-4">
				      <input type="text" class="form-control form-control-sm" name = "deskripsi" id="deskripsi" placeholder="masukkan deskripsi" autofocus="" value="">
	...
	$("#btn_simpan").click(function() {
		...
		if(nama_pas=="") {
			...
			$.ajax({
				...
				data: "no_diagnosa="+no_diagnosa+"&no_daftar="+no_daftar+"&tgl_diagnosa="+tgl_diagnosa+"&nm_dokter="+nm_dokter+"&nama_pas="+nama_pas+"&nomor_rm="+nomor_rm+"&tgl_lahir="+tgl_lahir+"&code="+code+"&diagnosa="+diagnosa+"&deskripsi="+deskripsi+"&subjective="+subjective+"&objective="+objective+"&assesment="+assesment+"&plan="+plan,
    ...
    $(document).ready(function(){  
      $('#editable_table').Tabledit({
        ...
        columns:{
          ...
          editable:[ [1, 'diagnosa'], [2, 'deskripsi']]
        },
        restoreButton:true,
