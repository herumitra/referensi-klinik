...
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Pemeriksaan Lab Rajal</h4></div>
...
?>
 ...
 <form role="form" class="form-horizontal" method="GET" action="laporan/laporan_pemeriksaanlab_rajal.php" target="_blank">
