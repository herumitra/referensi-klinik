...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Informasi Biaya Pasien</h4></div>
...
<!--       <div class="form-group row">
            ...
            <div class="col-sm-4">
                                    <div class="input-group">
                                      ...
                                      <input  id="total_penjualan"  onkeyup="sum();" placeholder="" type="text" value="<?php echo  ($tot_bayar+$totel_bayar+$totalBayar+$total_hari+$tot_bayar_lab+$tot_bayar_rad); ?>" class="form-control" placeholder="0">
                                    </div>
  ...
  <!--         <label for="nomor_rm" class="col-sm-2 col-form-label" style="text-align: right;">Administrasi</label>
            <div class="col-sm-4">
                                    <div class="input-group">
                                      ...
                                      <input  id="administrasi"  onkeyup="sum();" value="<?php echo ($adminis+$nol); ?>" placeholder="" type="number" class="form-control" placeholder="0">
                                    </div>
          </div>
          </div>
      ...
      <div class="form-group row">
            ...
            <div class="col-sm-4">
                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control"  id="total_bayar"   aria-label="Sizing example input" 
                                      value="<?php echo ($total_afterdiskon)+($tot_bayar+$totel_bayar+$totalBayar+$total_hari+$tot_bayar_lab+$tot_bayar_rad); ?>" aria-describedby="inputGroup-sizing-sm" >
                                    </div>
 ...
 <div class="form-group row">
        ...
        <div class="input-group">
          ...
          <input type="text" id="total_afterdiskon"    value="<?php echo $total_afterdiskon; ?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" >
        </div>
</div>
</div>
  ...
  $("#btn_simpan").click(function() {
    ...
    if(kode=="") {
      ...
      $.ajax({
        ...
        data: "total_penjualan="+total_penjualan+"&diskon="+diskon+"&total_afterdiskon="+total_afterdiskon+"&kode="+kode+"&jml_uang="+jml_uang+"&jml_kembali="+jml_kembali+"&administrasi="+administrasi,
