...
<div class="page-content">
 ...
 <div class="form-group row">
                    ...
                    <div class="col-sm-4">
<input type="text" onkeyup="isi_otomatis()" id="kamar_asal" name="kamar_asal" value ="<?php echo $data['kamar']; ?>" class="form-control" >
</div> 
...
<input type="text" id="no_bed_asal" name="no_bed_asal" value ="<?php echo $data['no_bed']; ?>"  class="form-control">

<input type="text" id="idruang_asal" name="idruang_asal" value ="<?php echo $data['id_ruang']; ?>"  class="form-control">
...
<div class="form-group row">
				    <label for="kamar" class="col-sm-2 col-form-label">To Ruangan</label>
				    <div class="col-sm-4">
...
<input type="hidden" class="form-control form-control-sm" id="id_ruangan" name="id_ruangan">
					...
					<label for="no_bed" class="col-sm-2 col-form-label" style="text-align: right;">To Nomor BED</label>
				    <div class="col-sm-4">
...
<input type="text" id="no_bed" name="no_bed"  class="form-control">
 ...
 <div class="form-group row">
              ...
              <input type="hidden" class="form-control form-control-sm" name="idruang" id="idruang" placeholder="masukkan Deposit" >
					</div>
...
var dokter = $("#dokter").val();
        ...
        var idruang_asal = $("#idruang_asal").val();
