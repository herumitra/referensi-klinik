...
<!-- 				      <small class="form-text text-muted" style="text-align: right;">bulan/tanggal/tahun</small> -->
 ...
 <div class="form-group row">
				    <label for="nama_pas" class="col-sm-2 col-form-label">Cara Bayar</label>
				    <div class="col-sm-4">
...
<input type="hidden" class="form-control form-control-sm" id="id_ruangan" name="id_ruangan">
				    ...
				    <div class="col-sm-4">
				      ...
				      <input type="hidden" class="form-control form-control-sm" name="idruang" id="idruang" >
