...
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Pemakaian Obat</h4></div>
...
?>
 ...
 <form role="form" class="form-horizontal" method="GET" action="laporan/laporan_pemakaianobat_pasien.php" target="_blank">
