...
<!--  <div class="form-group row">
				    ...
				    <div class="col-sm-4"> -->
				    	  <input type="hidden" class="form-control form-control-sm" name="status" id="status" value="daftar" placeholder="masukkan Deposit" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        require_once "koneksi.php";
         $query_tampil = "SELECT * FROM ruangan ORDER BY kamar ASC";
...
var id_pas = $("#id_pas").val();
	...
	if(nama_pas=="") {
			...
			Swal.fire(
			  'Data Belum Lengkap',
			  'maaf, tolong isi cara masuk pasien',
			  'warning'
			)
} else if (kamar=="") {
			...
			Swal.fire({
	          ...
	          if (ya.value) {
	            $.ajax({
	              ...
	              data: "no_daftar="+no_daftar+"&tgl_daftar="+tgl_daftar+"&nama_pas="+nama_pas+"&nomor_rm="+nomor_rm+"&nik="+nik+"&jk_pas="+jk_pas+"&tpt_lahir="+tpt_lahir+"&tgl_lahir="+tgl_lahir+"&asuransi_pas="+asuransi_pas+"&no_bpjs="+no_bpjs+"&no_hp="+no_hp+"&alm_pas="+alm_pas+"&desa="+desa+"&kec="+kec+"&kab_kota="+kab_kota+"&provinsi="+provinsi+"&nama_pj="+nama_pj+"&kontak_pj="+kontak_pj+"&hubungan_pj="+hubungan_pj+"&deposit="+deposit+"&cara_masuk="+cara_masuk+"&diagnosa_awal="+diagnosa_awal+"&dokter="+dokter+"&kamar="+kamar+"&no_bed="+no_bed+"&tarif="+tarif+"&kelas="+kelas+"&status="+status+"&ket="+ket+"&tgl_masuk="+tgl_masuk+"&tgl_pulang="+tgl_pulang+"&id_pas="+id_pas,
