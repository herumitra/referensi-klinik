            ...
            Swal.fire({
              ...
              if (ya.value) {
                $.ajax({
                  ...
                  data: "nama_pas="+nama_pas+"&nomor_rm="+nomor_rm+"&jk_pas="+jk_pas+"&tgl_lahir="+tgl_lahir+"&tpt_lahir="+tpt_lahir+"&asuransi_pas="+asuransi_pas+"&no_bpjs="+no_bpjs+"&diagnosa_awal="+diagnosa_awal+"&dokter="+dokter+"&kamar="+kamar+"&no_bed="+no_bed+"&tarif="+tarif+"&no_daftar="+no_daftar,
