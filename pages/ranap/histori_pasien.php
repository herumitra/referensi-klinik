...
<div class="page-content">
	<div class="row">
		<div class="col-6" id="judul"><h4>Informasi Kepulangan Pasien</h4></div>
	...
	<div class="table-container">
		...
		<?php 
			...
			where ket = 'close' ORDER BY no_daftar DESC";
		 ...
		 ?>
		 		<tr>
		 			...
		 			<td width="12%"><?php echo $data['nama_pas']; ?><br><small>
		 			 <?php echo $data['jk_pas']; ?></small></td>
	...
	<td><?php echo $data['lhr_pas']; ?><br><small>
                <?php $lahir    =new DateTime($data['lhr_pas']);
                    ...
                    <small><?php echo $data['no_bed']; ?></small>
		 			...
		 			<td><?php echo $data['kamar_asal']; ?>
		 				<br>
                    <small><?php echo $data['no_bed_asal']; ?></small>
		 			...
		 			<td width="10%" class="td-opsi">
                        ...
                        <!-- <a href="?page=edit_datapasien&id=<?php echo $data['id_peg']; ?>"> -->
	                        ...
	                        <button class="btn-transition btn btn-outline-primary" title="Cancel Pulang" id="tombol_edit" name="tombol_edit" data-id="<?php echo $data['no_daftar']; ?>">
...
<script>
	...
	$("button[name='tombol_edit']").click(function() {
		var id = $(this).data('id');
		window.location='?page=edit_histori_pasien&id='+id;
	});
