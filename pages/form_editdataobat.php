	...
	<div class="form-container">
		<div class="row">
			<div class="col-md-6 offset-md-3 offset-form">
				...
				?>
				<form action="javascript:void" autocomplete="off" id="form_editobat">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <select name="ip_bntobat" id="ip_bntobat" class="form-control form-control-sm">
				      	...
				      	<option value="VIAL" <?php if($data['bnt_obat']=="VIAL") {echo "selected";} ?>>Batang</option>
					      	<option value="AMPUL" <?php if($data['bnt_obat']=="AMPUL") {echo "selected";} ?>>Batang</option>
				      </select>
				    </div>
				  </div>
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <select name="ip_stobat" id="ip_stobat" class="form-control form-control-sm">
				      	...
				      	<option value="CC" <?php if($data['sat_obat']=="CC") {echo "selected";} ?> >Batang</option>
				      </select>
				    </div>
				  </div>
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <div class="input-group input-group-sm">
						  ...
						  <input type="number" class="form-control" id="ip_hrgobat" name="ip_hrgobat" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="<?php echo $data['hrg_obat']; ?>">
					  </div>
				    </div>
				  </div>
				  <div class="form-group row">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-4">
					    ...
					    <input type="hidden" id="ip_nmrstok<?php echo $no; ?>" name="ip_nmrstok[]" value="<?php echo $data_stok['no_stok'] ?>" disabled="">
					</div>
					<label for="ip_stok<?php echo $no; ?>" class="col-sm-1 col-form-label" style="text-align: right;">Stok</label>
				    <div class="col-sm-4">
					    <input type="number" class="form-control form-control-sm" id="ip_stok<?php echo $no; ?>" name="ip_stok[]" value="<?php echo $data_stok['stk_obat'] ?>" disabled="">
					</div>
				  </div>
				  <?php $no++; } ?>
				  <div class="form-group row">
