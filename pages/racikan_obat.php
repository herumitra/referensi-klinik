...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Tambah Obat Racik</h4></div>
  ...
  <form method="post" id="form_racikan" autocomplete="off">
        ...
        <div class="row" style="padding: 0 20px;">
            <div class="col-md-12 vertical-form">
                <?php 
                      $carikode = mysqli_query($conn, "SELECT MAX(kd_racik) as kodeTerbesar FROM tbl_nama_racikan ") ;
                    $datakode = mysqli_fetch_array($carikode);
                    $kd_racik = $datakode['kodeTerbesar'];
                    $urutan = (int) substr($kd_racik, 3, 3);
                    $urutan =$urutan+1;
                    $huruf = "RAC";
$kd_racik = $huruf . sprintf("%03s", $urutan);
...
<div class="row data-racikan">
 ...
 <label for="nama_racikan" class="">Nama Racikan</label>
                            <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" id="nama_racikan" name="nama_racikan" placeholder="masukkan nama pasien" autofocus="" value="" >
                                </div>
</div>
  <div class="position-relative form-group col-md-4">
     <label for="nama_racikan" class="">Stok</label>
                            <div class="input-group">
                                    <input type="number" class="form-control form-control-sm" id="stk_obat" name="stk_obat" placeholder="masukkan stok racikan" autofocus="" value="" >
                                </div>
</div>
  <div class="position-relative form-group col-md-4">
     <label for="nama_racikan" class="">Harga Racikan</label>
                            <div class="input-group">
                                    <input type="number" class="form-control form-control-sm" id="hrg_racikan" name="hrg_racikan" placeholder="masukkan stok racikan" autofocus="" value="" >
                                </div>
</div>
...
var hrg_racikan = $("#hrg_racikan").val();
