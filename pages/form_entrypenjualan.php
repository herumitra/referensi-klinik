	...
	<div class="row">
		...
		<div class="col-6 text-right">
			<a href="?page=datapenjualan">
                ...
                <a href="?page=laporpenjualan">
                <button class="btn btn-sm btn-warning" title="Export Data Penjualan">Laporan Penjualan Obat</button>
            </a>
		</div>
	</div>
...
/*            "SELECT * FROM tbl_dataobat INNER JOIN tbl_stokexpobat ON tbl_dataobat.kd_obat = tbl_stokexpobat.kd_obat WHERE tbl_stokexpobat.tgl_exp > date_add(CURDATE(), INTERVAL 10 DAY) AND tbl_stokexpobat.stok > 0 ORDER BY tbl_dataobat.nm_obat ASC";*/
                        ...
                        success:function(data) {
                            Swal.fire({
                              ...
                              if (ok.value) {
                                ...
                                window.open("laporan/nota_penjualan.php?no_pjl="+no_penjualan);
                                location.reload();
                              }
                            })
                        }
