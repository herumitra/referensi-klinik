...
<div class="page-content">
	<div class="row">
		<div class="col-6" id="judul"><h4>Data Farmasi Rajal</h4></div>
		<div class="col-6 text-right">
			<a href="?page=bankdata">
				<button class="btn btn-sm btn-info">Pendaftaran Pasien</button>
			</a>
			                <a href="?page=lapor_pemakaian_obat_rajal">
                <button class="btn btn-sm btn-warning" title="Export Data Penjualan">Laporan Pemakaian Obat Rajal</button>
...
<td><div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li> 
<a href="laporan/cetak_etiket.php?no_daftar=<?php echo $data['no_daftar']; ?>" target="_blank">
                              <button class="btn-transition btn btn-outline-dark btn-sm" title="cetak Etiket" id="tombol_cetak" name="tombol_cetak">
                                  <i class="fas fa-print"></i> Etiket</a> </li>
								</ul>
							</div></td>
...
<!-- <td>
   ...
   <button class="btn-transition btn btn-outline-success btn-sm" title="Retur Obat" id="tombol_retur_obat" name="tombol_retur_obat" data-id="<?php echo $data['no_daftar']; ?>">
...
$("button[name='tombol_retur_obat']").click(function() {
    var id = $(this).data('id');
	...
	$("button[name='tombol_obatpasien']").click(function() {
		var id = $(this).data('id');
		window.location='?page=farmasi_obat_rajal&id='+id;
	});

	$("button[name='tombol_obatracik']").click(function() {
		var id = $(this).data('id');
		window.location='?page=farmasi_obatracik_rajal&id='+id;
	});
		...
		var id = $(this).data('id');
		window.location='?page=lab_hematologi_jalan&id='+id;
	});
