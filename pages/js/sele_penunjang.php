...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Data Pemeriksaan Penunjang</h4></div>
        <div class="col-6 text-right">
      <!-- <a href="?page=form_laporanpembelian" class="btn btn-sm btn-pink">
        Buat Laporan Pembelian
      </a> -->
      <a href="?page=laporpembelian" class="btn btn-sm btn-pink">
        Buat Laporan Pembelian
      </a>
    ...
    <div class="kotak-data-tab">
        <ul class="nav nav-pills" id="pills-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" id="dpembelian_lunas-tab" data-toggle="pill" href="#dpembelian_lunas" role="tab" aria-controls="dpembelian_lunas" aria-selected="true">Laboratorium </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="dpembelian_utang-tab" data-toggle="pill" href="#dpembelian_utang" role="tab" aria-controls="dpembelian_utang" aria-selected="false">Radiologi</sup></a>
          </li>

          <li class="nav-item">
            <a class="nav-link" id="dpembelian_bayar-tab" data-toggle="pill" href="#dpembelian_bayar" role="tab" aria-controls="dpembelian_bayar" aria-selected="false">Pemeriksaan Lain</sup></a>
          </li>
        ...
        <div class="row" style="padding: 0 20px;">
            <div class="col-md-12 vertical-form">
                <?php 
                    ...
                    $carikode = mysqli_query($conn, "SELECT MAX(no_labor) FROM tbl_labor WHERE tgl_labor = '$tgl_labor'") or die (mysql_error());
                    $datakode = mysqli_fetch_array($carikode);
                    if($datakode) {
                        $nilaikode = substr($datakode[0], 13);
                        $kode = (int) $nilaikode;
                        $kode = $kode + 1;
                        $no_labor = "Lab/".$tgl."/".str_pad($kode, 2, "0", STR_PAD_LEFT);
                    } else {
                        $no_labor = "Lab/".$tgl."/01";
                    }
                 ?>
                ...
                <div style="text-align: right;">
                    No labor : <b><?php echo $no_labor; ?></b> Tanggal : <b><?php echo tgl_indo(date('Y-m-d')); ?></b>
                </div>
              
                    <div class="position-relative row form-group">
                        <!-- <label for="no_penjualan" class="col-sm-2 col-form-label">Nomor Penjualan</label> -->
                        <div class="col-sm-4">
                            <input name="no_labor" id="no_labor" placeholder="nomor labor" type="hidden" class="form-control form-control-sm" value="<?php echo $no_labor; ?>">
                        </div>
                    ...
                    <div class="row kotak-form-tabel-labor">
                        <div class="col-md-3 kotak-form-labor-terjual" style="display: ;">
                            ...
                            <!-- <form action="javascript:void(0);">  -->
                                ...
                                <div class="position-relative form-group">
                                    <label for="nama_labor" class="">Nama labor</label>
                                    <input name="nama_labor" id="nama_labor" placeholder="" type="text" class="form-control form-control-sm" disabled="">
                                </div>
                                <div class="position-relative form-group">
...
<!--                                 <div class="position-relative form-group">
                ...
                <br>
<h5 align="center"> Riwayat labor Pasien</h5>                
...
<!--                     <th>No Reg</th> -->
    ...
    $no_daftar = @$_GET['id'];
                ...
                $nomor = 1;
                $query_pjllabor = "SELECT tbl_labordetail.*, tbl_labordetail.kd_labor,tbl_labordetail.kd_labor, tbl_labor.no_daftar,tbl_labor.nm_dokter, data_labor.kd_labor, data_labor.nama_labor FROM tbl_labordetail
                ...
                $sql_pjllabor = mysqli_query($conn, $query_pjllabor) or die ($conn->error);
             ?>
            <tbody>
            <?php  
                while($data_pjllabor = mysqli_fetch_array($sql_pjllabor)) {
            ?>
                <tr>
                    <td><?php echo $nomor++; ?></td>
<!--                     <td><?php echo $data_pjllabor['no_daftar']; ?></td> -->
                    <td><?php echo $data_pjllabor['nm_dokter']; ?></td>
                    <td><?php echo $data_pjllabor['nama_labor']; ?></td>
                    <td><?php echo $data_pjllabor['hrg_labor']; ?></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
...
/*            $query_tampil = "SELECT * FROM tbl_dataobat INNER JOIN tbl_stokexpobat ON tbl_dataobat.kd_obat = tbl_stokexpobat.kd_obat WHERE tbl_stokexpobat.tgl_exp > date_add(CURDATE(), INTERVAL 10 DAY) AND tbl_stokexpobat.stok > 0 ORDER BY tbl_dataobat.nm_obat ASC";*/
         ...
         ?>
                <tr>
                    ...
                    <td><?php echo $data['nama_labor']; ?></td>
                    <td><?php echo $data['harga_labor']; ?></td>
                    <td class="td-opsi">
                        <button class="btn-transition btn btn-outline-dark btn-sm" title="pilih" id="tombol_pilihlabor" name="tombol_pilihlabor" data-dismiss="modal"
                            ...
                            data-nama="<?php echo $data['nama_labor']; ?>"
                            data-harga="<?php echo $data['harga_labor']; ?>"
                        > pilih
                        </button>
                    </td>
                </tr>
...
$(document).ready(function() {
   ...
   /* $("#jml_uang").keyup(function() {
    ...
    $("#form_labor").on("submit", function(event){
        ...
        if(no_labor=="") {
            document.getElementById("no_labor").focus();
            Swal.fire(
              'Data Belum Lengkap',
