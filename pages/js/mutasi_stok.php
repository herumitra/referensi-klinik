 ...
 <h5> Pesanan Obat Masuk ke Gudang Farmasi </h5>
        <table  id="editable_table" class="table table-striped display tabel-data">
            ...
            <?php 
                ...
                $nomor = 1;
                     $query_pjlobat = "SELECT * from tbl_dataobat  ";
...
$status = $row['status'];
            ...
            ?>
                             ...
                             <tbody>
        <?php 
   $query_tampil = "SELECT * From tbl_dataobat where status ='$status' ";
...
$("button[name='tombol_simpanan']").click(function() {
        ...
        window.location='?page=simpanan_mutasi&id='+id;
    });
