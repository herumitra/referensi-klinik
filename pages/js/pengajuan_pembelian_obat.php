 ...
 <h5> Pesanan Obat Masuk ke Gudang Farmasi </h5>
        <table  id="editable_table" class="table table-striped display tabel-data">
            ...
            <?php 
                ...
                $nomor = 1;
                     $query_pjlobat = "SELECT tbl_dataobat.nm_obat, tbl_pengajuandetail_pembelian.no_faktur,tbl_pengajuandetail_pembelian.hrg_beli, tbl_pengajuandetail_pembelian.jml_beli, tbl_pengajuandetail_pembelian.sat_beli, tbl_pengajuandetail_pembelian.subtotal, tbl_pengajuandetail_pembelian.no_idx FROM tbl_pengajuandetail_pembelian INNER JOIN tbl_dataobat ON tbl_pengajuandetail_pembelian.kd_obat = tbl_dataobat.kd_obat WHERE tbl_pengajuandetail_pembelian.no_faktur = '$no_faktur'";
...
<br>
     <div class="row" style="padding: 0 16px;">
            <div class="col-md-12 vertical-form">
 <h5>  Konfirmasi Obat Masuk ke Gudang Farmasi  </h5>
        <table  id="editable_table" class="table table-striped display tabel-data">
            <thead>
                <tr>
                    <th>No</th>
            ...
            <?php 
                ...
                $nomor = 1;
$query_pjlo = "SELECT tbl_dataobat.nm_obat, tbl_pengajuan_pesan_pembelian.no_faktur,tbl_pengajuan_pesan_pembelian.hrg_beli, tbl_pengajuan_pesan_pembelian.jml_beli, tbl_pengajuan_pesan_pembelian.sat_beli, tbl_pengajuan_pesan_pembelian.subtotal , tbl_pengajuan_pesan_pembelian.status FROM tbl_pengajuan_pesan_pembelian INNER JOIN tbl_dataobat ON tbl_pengajuan_pesan_pembelian.kd_obat = tbl_dataobat.kd_obat WHERE tbl_pengajuan_pesan_pembelian.no_faktur = '$no_faktur'";
        ...
        $kode=$datak['no_faktur'];       
                echo '
                <tr>
                 <td>'.$datak["no_faktur"].'</td>
                 <td>'.$datak["nm_obat"].'</td>
            ...
            ?>
                             ...
                             <tbody>
        <?php 
   $query_tampil =  "SELECT tbl_dataobat.nm_obat, tbl_pengajuan_pesan_pembelian.no_faktur,tbl_pengajuan_pesan_pembelian.hrg_beli, tbl_pengajuan_pesan_pembelian.jml_beli, tbl_pengajuan_pesan_pembelian.sat_beli, tbl_pengajuan_pesan_pembelian.subtotal, tbl_pengajuan_pesan_pembelian.kd_obat FROM tbl_pengajuan_pesan_pembelian INNER JOIN tbl_dataobat ON tbl_pengajuan_pesan_pembelian.kd_obat = tbl_dataobat.kd_obat WHERE tbl_pengajuan_pesan_pembelian.no_faktur = '$no_faktur'";
...
$("button[name='tombol_simpanan']").click(function() {
        ...
        window.location='?page=simpanan_ajuan_pembelian&id='+id;
    });
