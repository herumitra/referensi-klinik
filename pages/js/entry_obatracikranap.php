...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Form Pemberian Obat Racik Ranap</h4></div>
		<div class="col-6 text-right">
                        <a href="?page=racikanobat">
                <button class="btn btn-sm btn-info">Tambah Obat Racik</button>
			</a>
                        <a href="?page=tabelracikan">
                <button class="btn btn-sm btn-info">Tabel Obat Racik</button>
            </a>
                    		...
                    		<!-- <form action="javascript:void(0);">  -->
                    			<div class="position-relative form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_dataobatracik" id="lihat_data_obat"><i class="fas fa-search"></i></button>
                                        </div>
                                    </div>
                    			</div>
                                <div class="position-relative form-group">
...
<!-- Modal -->
<div class="modal fade" id="modal_dataobatracik" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
/*  $query_tampil = "SELECT * FROM tbl_nama_racikan INNER JOIN tbl_nama_racikandetail ON tbl_nama_racikan.kd_racik = tbl_nama_racikandetail.kd_racik ORDER BY tbl_nama_racikan.nama_racikan ASC";  
*/

/*            $query_tampil = "SELECT * FROM tbl_dataobat INNER JOIN tbl_stokexpobat ON tbl_dataobat.kd_obat = tbl_stokexpobat.kd_obat WHERE tbl_stokexpobat.tgl_exp > date_add(CURDATE(), INTERVAL 100 DAY) AND tbl_stokexpobat.stok > 0 ORDER BY tbl_dataobat.nm_obat ASC";*/
                ...
                <tr>
                    ...
                    <td class="td-opsi">
                        <button class="btn-transition btn btn-outline-dark btn-sm" title="pilih" id="tombol_pilihobat" name="tombol_pilihobat" data-dismiss="modal"
                            data-kode="<?php echo $data['kd_racik']; ?>"
                            data-nama="<?php echo $data['nama_racikan']; ?>"
                            data-stok="<?php echo $data['stk_obat']; ?>"
                            data-harga="<?php echo $data['total_penjualan']; ?>"
                        > pilih
                        </button>
                    </td>
                </tr>
            ...
            <div class="col-md-12 vertical-form">
                    ...
                    <div class="row data-pengobatan">
                        <div class="position-relative form-group col-md-3">
                            <label for="no_daftar" class="">Cari Isi Racikan Obat </label>
                            <div class="input-group input-group-sm">
