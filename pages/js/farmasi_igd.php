...
<div class="page-content">
	<div class="row">
		<div class="col-6" id="judul"><h4>Data Farmasi IGD</h4></div>
	...
	<div class="table-container">
		<table id="example" class="table table-striped display tabel-data" >
		    ...
		    <tbody>
		<?php 
			$query_tampil = "SELECT * FROM tbl_daftarpasien_igd where tgl_daftar = CURDATE() AND status='rawat' ORDER BY no_antrian DESC"  ;
...
<script>
	...
	$("button[name='tombol_obatpasien']").click(function() {
		var id = $(this).data('id');
		window.location='?page=farmasi_obat_igd&id='+id;
	});

	$("button[name='tombol_obatracik']").click(function() {
		var id = $(this).data('id');
		window.location='?page=farmasi_obatracik_igd&id='+id;
	});
