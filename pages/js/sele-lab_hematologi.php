...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Laboratorium </h4></div>
...
<div class="row" style="padding: 0 20px;">
      <div class="col-md-12 vertical-form">
                <?php 
                    ...
                    $carikode = mysqli_query($conn, "SELECT MAX(no_pengobatan) FROM tbl_hematologi WHERE tgl_pengobatan = '$tgl_pengobatan'") or die (mysql_error());
  ...
  <?php 
        require_once "koneksi.php";
                $nomor = 1;
                     $query_tamp = "SELECT tbl_hematologi_pesan.kd_hematologi, tbl_hematologi_pesan.hasil, tbl_hematologi_pesan.hrg_jual,tbl_hematologi_pesan.subtotal,tbl_nama_hematologi.kd_hematologi, tbl_nama_hematologi.nama_hematologi,  data_labor.nm_labor, data_labor.kd_labor FROM tbl_hematologi_pesan
         ...
         ?>
                                   ...
                                   <tr>  
                                        ...
                                        <input style="width:50px" name="hasil[]"  value="<?php echo $data['hasil'];?>"  class="col-sm-2 col-form-label">
                                        ...
                                        <input style="width:120px" name="kd_hematologi[]"  value="<?php echo $kode; ?>"  class="col-sm-2 col-form-label">
                                        <input  style="width:130px" name="kd_labor[]"  value="<?php echo $data['kd_labor'];?>"  class="col-sm-2 col-form-label">
                                        </td>  
                                        <td>
...
<!-- Modal Edit Mahasiswa-->
            <div class="modal fade" id="myModal<?php echo $data['no']; ?>" role="dialog">
              <div class="modal-dialog">
                ...
                WHERE no_daftar ='$no_daftar' ";
              $sql_ku = mysqli_query($conn, $query_pjlobat) or die ($conn->error);  

                        //$result = mysqli_query($conn, $query);
                while($datasu = mysqli_fetch_array($sql_ku)) {

                        ?>

                        <input type="hidden" name="no" id="no" value="<?php echo $datasu['no']; ?>">

                        <div class="form-group">
                          <label>Nama</label>
                          <input type="text" name="nama" id="nama" class="form-control" value="<?php echo $datasu['nama_hematologi']; ?>">      
                        </div>

                        <div class="form-group">
                          <label>Fakultas</label>
                          <input type="text" name="kesan" id="kesan" class="form-control" value="<?php echo $datasu['kesan']; ?>">      
                        </div>
                        
                        <div class="modal-footer">  
                          <button type="submit" class="btn btn-success" id="btn_save">Update</button>
...
$subharga= $row["hasil"]*$row["hrg_jual"];
                echo '
                <tr>
                 <td>'.$row["id"].'</td>
                 <td>'.$row["name"].'</td>
    ...
    $("#btn_save").click(function() {
        ...
        if(no=="") {
            ...
            $.ajax({
                ...
                data: "nama="+nama+"&kesan="+kesan+"&no="+no,
                success: function(hasil) {
                    if(hasil=="berhasil") {
                        Swal.fire({
                          title: 'Berhasil',
