...
<div class="form-container">
                 ...
                 function search(){
                      ...
                      if(nama_racikan!=""){
                        $("#result").html("<img src='img/ajax-loader.gif'/>");
                         $.ajax({
                            type:"post",
                            url:"ajax/search_racik.php",
                            data:"nama_racikan="+nama_racikan+"&kd_racik="+kd_racik,
     ...
     <div class="row" style="padding: 0 16px;">
            <div class="col-md-12 vertical-form">
 <h5> Edit & Tambah Nama Racikan Obat </h5>
...
";
 ...
 $dewan1 = $conn->prepare($query_pjlobat);
  ...
  <?php 
        require_once "koneksi.php";
                $nomor = 1;
                     $query_tamp = "SELECT tbl_nama_racikandetail.kd_racik,tbl_nama_racikandetail.no, tbl_nama_racikandetail.jumlah,tbl_nama_racikandetail.hrg_jual, tbl_dataobat.nm_obat, tbl_nama_racikan.kd_racik, tbl_nama_racikan.nama_racikan FROM tbl_nama_racikandetail
                  LEFT JOIN tbl_nama_racikan ON tbl_nama_racikandetail.kd_racik=tbl_nama_racikan.kd_racik
                  LEFT JOIN tbl_dataobat ON tbl_nama_racikandetail.kd_obat=tbl_dataobat.kd_obat where tbl_nama_racikandetail.kd_racik='$kd_racik'";
         ...
         ?>
                                   ...
                                   <tr>  
                                        <td>                                         
                                        <input style="width:200px"  name="name[]"  value="<?php echo $data['kd_racik'];?>" class="col-sm-2 col-form-label">
                                        ...
                                        <input style="width:200px" name="jumlah[]"  value="<?php echo $data['jumlah'];?>"  class="col-sm-2 col-form-label">
                                        <input style="width:200px" name="racikan[]"  value="<?php echo $data['nama_racikan'];?>"  class="col-sm-2 col-form-label">
                                        <input style="width:200px" name="noreg[]"   class="col-sm-2 col-form-label">
                                        </td>  
