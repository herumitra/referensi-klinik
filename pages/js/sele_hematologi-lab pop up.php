...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Laboratorium Rajal </h4></div>
...
<div class="row" style="padding: 0 20px;">
  ...
  <button class="btn btn-danger btn-sm hapus_data" title="Hapus" id="tombol_hapus_hematologi" name="tombol_hapus_hematologi" data-id="<?php echo $data['kd_hematologi']; ?>" >
     <i class="fa fa-trash"></i> Hapus </button>
        ...
        <table  id="employee_table"  class="table table-striped display tabel-data">
            <thead>
                <tr>
                    <th>No</th>
<!--                     <th>No Reg</th> -->
...
<!--   <a href="#" type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal<?php echo $data['id']; ?>">Edit</a>
 -->
<button type="button" name="edit" value="Edit" id="<?php echo $data["no"]; ?>" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_dokter" ><i class="fas fa-file-signature"></i></button>
...
<?php 
 ...
 ?>
<form role="form" action="pages/akai/edit_hematologi.php" method="GET">

              <input type="text" class="form-control form-control-sm" id="id" placeholder="masukkan no" value="<?php echo $id; ?>" disabled="">


          <div class="form-group row pt-3">
           <label for="no" class="col-sm-3 col-form-label">Pemeriksaan </label> 
            <div class="col-sm-9">
              <input type="text" class="form-control form-control-sm" name="nama" id="nama" placeholder="masukkan Pemeriksaan" value="<?php echo $nama; ?>" disabled="">
            </div>
          </div>
...
rows="5"
        name="kesan"       id="kesan" placeholder="masukkan kesan" autofocus="" ><?php echo $kesan; ?></textarea>
            </div>
          </div>
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control form-control-sm"
               name="expired" id="expired" value="<?php echo $tanggal; ?>">
            </div>
          </div>
...
/*                                window.location='?page=lab_hematologi&id='+no_daftar;*/
                                ...
                                window.location='?page=labor_rajal';                                
...
$(document).on('click', '.hapus_data', function(){
    ...
    $.ajax({
        type: 'POST',
        url: "pages/js/hapus_data_hema.php",
        data: {id:id},
        success: function() {
            $('.data').load("lab_hematologi_jalan.php");
