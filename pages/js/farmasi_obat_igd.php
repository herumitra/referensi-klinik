...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Farmasi IGD</li>
  </ol>
</nav>

<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Form Farmasi Obat IGD </h4></div>
        <div class="col-6 text-right">
            <a href="?page=farmasi_igd">
                <button class="btn btn-sm btn-info">Farmasi IGD</button>
            </a>
        </div>
    </div>
