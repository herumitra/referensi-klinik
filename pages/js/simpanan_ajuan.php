...
$query =mysqli_query($conn,"INSERT INTO 
    tbl_pengajuan_pesan (no_idx, no_permintaan, kd_obat, exp_obatbeli, hrg_beli, jml_beli, sat_beli, subtotal, no_depo, id_peg, status) 
SELECT
no_idx, no_permintaan, kd_obat, exp_obatbeli, hrg_beli, jml_beli, sat_beli, subtotal, no_depo, '$id_pegawai', 'Approval'
FROM
    tbl_pengajuandetail WHERE no_permintaan='$no_permintaan'");


$query_pjlobat = "SELECT * FROM tbl_pengajuan_pesan 

INNER JOIN tbl_farmasi ON tbl_pengajuan_pesan.no_depo = tbl_farmasi.no_depo 
...
$query8 = mysqli_query($conn, "UPDATE ".$nama_pet." SET stk_obat=stk_obat+".$dataku['jml_beli']."  WHERE  kd_obat='$Codec'");
...
$query7 = mysqli_query($conn, "UPDATE ".$nama_pet." SET stk_obat=stk_obat-".$dataku['jml_beli']." WHERE  kd_obat='".$dataku['kd_obat']."'");
