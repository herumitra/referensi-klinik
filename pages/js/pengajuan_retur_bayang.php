 ...
 $dewan1 = $conn->prepare($query_pjlobat);
         $dewan1->execute();
              ...
              while ($row = $res1->fetch_assoc()) {
                $subharga= $row["jml_jual"]*$row["hrg_jual"];
                echo '
                <tr>
                 <td>'.$row["no"].'</td>
            ...
            ?>
                             ...
                             <tbody>
        <?php 
   $query_tampil = "SELECT tbl_pengobatandetail.*, tbl_pengobatandetail.kd_obat, tbl_pengobatan.no_daftar, tbl_dataobat.kd_obat, tbl_dataobat.nm_obat, tbl_dataobat.hrg_obat FROM tbl_pengobatandetail
                  LEFT JOIN tbl_pengobatan ON tbl_pengobatandetail.no_pengobatan=tbl_pengobatan.no_pengobatan
                  LEFT JOIN tbl_dataobat ON tbl_pengobatandetail.kd_obat=tbl_dataobat.kd_obat
...
<br>
     <div class="row" style="padding: 0 16px;">
            <div class="col-md-12 vertical-form">
 <h5>  Konfirmasi Retur Obat dari Ruangan  </h5>
        <table  id="editable_table" class="table table-striped display tabel-data">
            <thead>
                <tr>
                    <th>No</th>
            ...
            <?php 
                ...
                $nomor = 1;
$query_pjlo = "SELECT tbl_pengobatan_retur.*, tbl_pengobatan_retur.kd_obat, tbl_pengobatan.no_daftar, tbl_dataobat.kd_obat, tbl_dataobat.nm_obat, tbl_dataobat.hrg_obat FROM tbl_pengobatan_retur
                  LEFT JOIN tbl_pengobatan ON tbl_pengobatan_retur.no_pengobatan=tbl_pengobatan.no_pengobatan
                  LEFT JOIN tbl_dataobat ON tbl_pengobatan_retur.kd_obat=tbl_dataobat.kd_obat
        ...
        $kode=$datak['no_daftar'];       
            ...
            ?>
                             ...
                             <tbody>
        <?php 
   $query_tampil =  "SELECT tbl_pengobatan_retur.*, tbl_pengobatan_retur.kd_obat, tbl_pengobatan.no_daftar, tbl_dataobat.kd_obat, tbl_dataobat.nm_obat, tbl_dataobat.hrg_obat FROM tbl_pengobatan_retur
                  LEFT JOIN tbl_pengobatan ON tbl_pengobatan_retur.no_pengobatan=tbl_pengobatan.no_pengobatan
                  LEFT JOIN tbl_dataobat ON tbl_pengobatan_retur.kd_obat=tbl_dataobat.kd_obat
