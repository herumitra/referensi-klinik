...
<div class="page-content">
	...
	<!-- 	            <th>Opsi</th> -->
		...
		<?php 
                                        $no =1;
			$query_tampil = "SELECT tbl_dataobat.kd_obat, tbl_dataobat.nm_obat, tbl_dataobat.ktg_obat, tbl_dataobat.sat_obat, tbl_dataobat.stk_obat, SUM(tbl_pengajuan_pesan_pembelian.jml_beli) AS stok_masuk, stok_awal,stok_keluar
FROM tbl_dataobat 
