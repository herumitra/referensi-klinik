...
<nav aria-label="breadcrumb">
 ...
 <h5> Tabel Pesanan Racikan Obat </h5>
        <table  id="editable_table" class="table table-striped display tabel-data">
            ...
            <?php 
                ...
                $nomor = 1;
                     $query_pjlobat = "SELECT tbl_nama_racikandetail.kd_racik,tbl_nama_racikandetail.no, tbl_nama_racikandetail.jumlah,tbl_nama_racikandetail.hrg_jual, tbl_dataobat.nm_obat, tbl_nama_racikandetail.subtotal, tbl_nama_racikan.kd_racik FROM tbl_nama_racikandetail
...
*/
        $kode=$row['kd_racik'];        
            ...
            ?>
                             ...
                             <tbody>
        <?php 
   $query_tampil = "SELECT tbl_nama_racikandetail.kd_racik,tbl_nama_racikandetail.no, tbl_nama_racikandetail.jumlah,tbl_nama_racikandetail.hrg_jual, tbl_dataobat.nm_obat, tbl_nama_racikan.kd_racik, tbl_racikandetail.no_pengobatan FROM tbl_nama_racikandetail
                  LEFT JOIN tbl_nama_racikan ON tbl_nama_racikandetail.kd_racik=tbl_nama_racikan.kd_racik

                  LEFT JOIN tbl_racikandetail ON tbl_nama_racikandetail.kd_racik=tbl_racikandetail.kd_racik
...
data-no_pengobatan="<?php echo $nopen; ?>"


                                >
                                <i class="fas fa-medkit">Save</i>
</button>
  ...
  <form method="post" id="form_racikan" autocomplete="off">
                    ...
                    <div class="row data-pengobatan">
                        <div class="position-relative form-group col-md-4">
                            <label for="no_daftar" class="">Kode Racik</label>
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control form-control-sm" id="no_pengobatan" name="no_pengobatan" value="<?php echo $nopen; ?>" >
...
<!--  $query_tampil = "SELECT * FROM tbl_nama_racikan  WHERE status = 'aktif' ORDER BY nama_racikan ASC";
 -->
                  <?php 
                   ...
                   ?>
                        ...
                        <div class="position-relative form-group col-md-4">
                            <label for="nama_pas" class="">Nama Racikan</label>
                            <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" id="nama_racikan" name="nama_racikan" placeholder="masukkan nama pasien" autofocus="" value="<?php echo $data['nama_racikan']; ?>" disabled="">
                                </div>
     ...
     <label for="nama_racikan" class="">Stok</label>
                            <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" id="stk_obat" name="stk_obat" placeholder="masukkan stok racikan" autofocus="" value="<?php echo $data['stk_obat']; ?>">
                                </div>
                        </div>
 ...
 <script>  
    $(document).ready(function(){  
      $('#editable_table').Tabledit({
        ...
        columns:{
          identifier:[0, "no"],
          editable:[[2, 'jumlah'], [3, 'hrg_jual'], [4, 'subtotal']]
        },
        restoreButton:true,
