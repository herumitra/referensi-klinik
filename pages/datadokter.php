...
<div class="page-content">
	<div class="row">
		<div class="col-6" id="judul"><h4>Data Dokter</h4></div>
		<div class="col-6 text-right">
<button class="btn-transition btn btn-outline-success btn-xl" title="detail obat" id="tombol_detail" name="tombol_detail" data-toggle="modal" data-target="#detail_obat">
                            Tambah Dokter</i>
                        </button>
...
$kd_dokter = $huruf . sprintf("%03s", $urutan);
				...
				<form action="javascrip:void(0);"  autocomplete="off">
				  <div class="form-group row pt-3">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control form-control-sm"  name="kd_dokter" id="kd_dokter" value="<?php echo $kd_dokter; ?>" placeholder="masukkan kode dokter" autofocus="">
				    </div>
				  </div>
  <div class="col-sm-4">
				  ...
				  <div class="form-group row">
				    <label for="jasa_dok" class="col-sm-3 col-form-label">Jasa Dokter</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control form-control-sm" id="jasa_dok"  placeholder="masukkan spesialisasi" autofocus="">
				    </div>
				  </div>
	...
	$("#btn_save").click(function() {
		...
		if(kode=="") {
			...
			$.ajax({
				...
				data: "nm_dokter="+nm_dokter+"&kode="+kode+"&jk="+jk+"&tempat_lahir="+tempat_lahir+"&tgl_lahir="+tgl_lahir+"&alamat="+alamat+"&no_hp="+no_hp+"&spesialisasi="+spesialisasi+"&tgl_input="+tgl_input+"&jasa_dok="+jasa_dok,
				success: function(hasil) {
					if(hasil=="berhasil") {
						Swal.fire({
				          title: 'Berhasil',
