...
<div class="page-content">
	<div class="row">
		<div class="col-6" id="judul"><h4>Data Radiologi</h4></div>
		<div class="col-6 text-right">
  <a href="?page=tambah_dataradiologi">
...
/*			$no = 1;*/
		 ...
		 ?>
		 		<tr>
		 			...
		 			<td class="td-opsi">
                        <button class="btn-transition btn btn-outline-primary btn-sm" title="edit" id="tombol_edit" name="tombol_edit" data-id="<?php echo $data['kd_radiologi']; ?>">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn-transition btn btn-outline-danger btn-sm" title="hapus" id="tombol_hapus" name="tombol_hapus" data-id="<?php echo $data['kd_radiologi']; ?>" data-nama="<?php echo $data['nama_radiologi']; ?>">
...
<script>
	$("button[name='tombol_hapus']").click(function() {
		...
		Swal.fire({
          ...
          if (hapus.value) {
            $.ajax({
              type: "POST",
              url: "ajax/hapus.php?page=radiologi",
              data: "id="+id,
	...
	$("button[name='tombol_edit']").click(function() {
		var id = $(this).data('id');
		window.location='?page=edit_dataradiologi&id='+id;
	});
