			...
			<div class="col-md-6 offset-md-3 offset-form">
				...
				<form action="javascrip:void(0);"  autocomplete="off">
				  <div class="form-group row pt-3">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control form-control-sm"   id="kd_dokter" placeholder="masukkan kode dokter" autofocus="">
				    </div>
				  </div>
				  <div class="form-group row pt-3">
	...
	$("#btn_save").click(function() {
		...
		if(kode=="") {
			...
			$.ajax({
				...
				data: "nm_dokter="+nm_dokter+"&kode="+kode+"&jk="+jk+"&tempat_lahir="+tempat_lahir+"&tgl_lahir="+tgl_lahir+"&alamat="+alamat+"&no_hp="+no_hp+"&spesialisasi="+spesialisasi,
