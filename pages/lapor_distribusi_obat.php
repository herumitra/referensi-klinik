...
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Distribusi Obat</h4></div>
    <div class="col-6 text-right">
      <a href="?page=entry_datapengajuan">
        <button class="btn btn-sm btn-info">Data Distribusi</button>
      </a>
    </div>
  </div>
...
?>
           ...
           <form role="form" class="form-horizontal" method="GET" action="laporan/cetak_pengajuan_pembelian.php" target="_blank">
