...
<div class="page-content">
	<div class="row">
		<div class="col-6" id="judul"><h4>Data Laboratorium Rajal</h4></div>
		<div class="col-6 text-right">
			<a href="?page=bankdata">
				<button class="btn btn-sm btn-info">Pendaftaran Pasien</button>
			</a>
			                <a href="?page=laporan_pemeriksaan_rajal">
                <button class="btn btn-sm btn-warning" title="Export Data Penjualan">Laporan Pemeriksaan Lab Rajal</button>
...
<!--  		 			<td width="13%"><?php echo $data['jk_pas']; ?></td>
		 			...
		 			<td> 
		 				                         <button class="btn-transition btn btn-outline-primary btn-sm" title="Rekam Medis" id="tombol_suratnarkoba" name="tombol_suratnarkoba" data-id="<?php echo $data['no_daftar']; ?>">
...
<td><div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li> 
<a href="laporan/hematologi_rajal.php?no_daftar=<?php echo $data['no_daftar']; ?>" target="_blank"
                               class="btn-transition btn btn-outline-dark btn-sm" title="cetak Hematologi" id="tombol_cetak" name="tombol_cetak">
                                  <i class="fas fa-print"></i> Hematologi</a> </li>
									...
									<li> 
<a href="laporan/swab.php?no_daftar=<?php echo $data['no_daftar']; ?>" target="_blank"
                               class="btn-transition btn btn-outline-dark btn-sm" title="cetak Hematologi" id="tombol_cetak" name="tombol_cetak">
                                  <i class="fas fa-print"></i> Swab </a> </li>

									<li><a href="laporan/narkoba.php?no_daftar=<?php echo $data['no_daftar']; ?>" target="_blank"
...
<script>
	...
	$("button[name='tombol_suratnarkoba']").click(function() {
		var id = $(this).data('id');
		window.location='?page=suratnarkoba&id='+id;
	});
