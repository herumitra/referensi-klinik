   ...
   <style>
    ...
    <div class="kotak-data-tab">
        <ul class="nav nav-pills" id="pills-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" id="rekam_obat-tab" data-toggle="pill" href="#rekam_obat" role="tab" aria-controls="rekam_obat" aria-selected="true">Obat</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="rekam_tindakan-tab" data-toggle="pill" href="#rekam_tindakan" role="tab" aria-controls="rekam_tindakan" aria-selected="false">Tindakan</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" id="rekam_soap-tab" data-toggle="pill" href="#rekam_soap" role="tab" aria-controls="rekam_soap" aria-selected="false">SOAP</a>
          </li>
        ...
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="rekam_obat" role="tabpanel" aria-labelledby="rekam_obat-tab">
...
<!--                     <td><?php echo $data_pjlobat['hrg_jual']; ?></td> -->
                    ...
                    <td class="td-opsi">
                        ...
                        <!-- </a> -->
                        <button class="btn-transition btn btn-outline-danger btn-sm" title="hapus" id="tombol_hapus" name="tombol_hapus" data-id="<?php echo $data_pjlobat['no']; ?>" data-nama="<?php echo $data_pjlobat['no_pengobatan']; ?>"
...
<!-- tambahan  -->
        <div class="tab-pane fade" id="rekam_tindakan" role="tabpanel" aria-labelledby="rekam_tindakan-tab">
       ...
       <div class="tab-pane fade" id="rekam_soap" role="tabpanel" aria-labelledby="rekam_soap-tab">
            <div class="table-container">
