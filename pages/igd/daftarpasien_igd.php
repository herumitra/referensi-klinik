<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-light">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-align-left"></i> Form Perawatan IGD</li>
  </ol>
</nav> 

<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Pendaftaran Pasien IGD</h4></div>
  ...
  <div class="table-container">
    <table id="example" class="table table-striped display tabel-data">
      <thead>
        ...
        <tbody>
    <?php 
      $query_tampil = "SELECT * FROM tbl_daftarpasien_igd where tgl_daftar = CURDATE() ";
...
<!-- <a href="laporan/cetak_daftar_igd.php?no_daftar=<?php echo $data['no_daftar']; ?>" target="_blank">
 ...
 <a href="laporan/cetak_antrian.php?no_daftar=<?php echo $data['no_daftar']; ?>" target="_blank">
                          ...
                          <button class="btn-transition btn btn-outline-primary btn-sm" title="Transfer to Patien" id="tombol_transfer" name="tombol_transfer" data-id="<?php echo $data['no_daftar']; ?>">
...
<script>
  ...
  $("button[name='tombol_transfer']").click(function() {
    var id = $(this).data('id');
    window.location='?page=transfer_pasien_igd_toranap&id='+id;
  });
