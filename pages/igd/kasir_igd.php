...
<div class="page-content">
	<div class="row">
		<div class="col-6" id="judul"><h4>Data Kasir IGD </h4></div>
		<div class="col-6 text-right">
<!-- 			<a href="?page=datapenjualan">
				<button class="btn btn-sm btn-info">Data Penjualan Obat</button>
			</a> -->
			            <a href="?page=laporbiling_igd">
                <button class="btn btn-sm btn-warning">Laporan Billing IGD</button>
            </a>
<!--             </a>
	...
	<div class="table-container">
		<table id="example" class="table table-striped display tabel-data">
		    ...
		    <tbody>
		<?php 
			$query_tampil = "SELECT * FROM tbl_daftarpasien_igd where tgl_daftar = CURDATE() AND status='rawat' ORDER BY no_daftar DESC"  ;
                ...
                <?php $lahir    =new DateTime($data['lhr_pas']);
                    ...
                    ?></small>
		 			...
		 			<td width="10%" class="td-opsi">
	                        ...
	                        <a href="laporan/nota_pembayaran_igd.php?no_daftar=<?php echo $data['no_daftar']; ?>" target="_blank">
...
<script>
	...
	$("button[name='tombol_kasir']").click(function() {
		var id = $(this).data('id');
		window.location='?page=pembayaran_igd&id='+id;
	});
