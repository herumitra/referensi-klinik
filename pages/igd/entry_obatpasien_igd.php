                   ...
                   ?>
                    ...
                    <div class="position-relative form-group col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" class="form-control form-control-sm" id="no_depo" name="no_depo" value ='1'>
                                <div class="input-group-append">
        ...
        if(id==id_session) {
            ...
            Swal.fire({
              ...
              if (hapus.value) {
                $.ajax({
                  type: "POST",
                  url: "ajax/hapus.php?page=pengobatanan_igd",
            ...
            Swal.fire({
              ...
              if (simpan.value) {
                ...
                if(count_data > 0) {
                    ...
                    $.ajax({
                        url: "ajax/simpan_pengobatan_igd.php",
                        method: "POST",
                        data: form_data,
