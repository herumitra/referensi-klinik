...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Form Daftar Pasien IGD</h4></div>
		...
		<div class="row">
			<div class="col-md-10 offset-md-1 offset-form">
                ...
                <?php 
                    ...
                    $carikode = mysqli_query($conn, "SELECT MAX(no_daftar) FROM tbl_daftarpasien_igd WHERE tgl_daftar = '$tgl_daftar'") or die (mysql_error());
...
<!-- 				      	<option value="BPJS Kesehatan" <?php if($data['asuransi_pas'] == "BPJS Kesehatan") {echo "selected";} ?>>BPJS Kesehatan</option> -->
 ...
 <div class="form-group row">
					...
					<label for="tinggi_badan" class="col-sm-2 col-form-label" style="text-align: right;"></label>
				    <div class="col-sm-4">
...
<select name="dokter" id="dokter" class="form-control form-control-sm" >
 ...
 <div class="form-group row">
				    <label for="temp" class="col-sm-2 col-form-label">Instalasi IGD</label>
				    <div class="col-sm-4">
				      <input type="text" class="form-control form-control-sm" name="proses" id="proses" value="IGD" placeholder="poli" >
	...
	if(nama_pas=="") {
			...
			Swal.fire({
	          ...
	          if (ya.value) {
	            $.ajax({
	              type: "POST",
	              url: "ajax/daftar_pasien_igd.php",
