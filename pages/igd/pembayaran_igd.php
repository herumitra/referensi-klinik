...
<div class="page-content">
    <div class="row">
        <div class="col-6"><h4>Tagihan Pasien IGD</h4></div>
        ...
        <div class="row" style="padding: 0 16px;">
            <div class="col-md-12 vertical-form">
                  ...
                  <?php 
                   ...
                   ?>
                        ...
                        <div class="position-relative form-group col-md-2">
                            ...
                            <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" id="dokter" name="dokter" placeholder="masukkan nama dokter" autofocus="" value="<?php echo $dokter_periksa; ?>" disabled="">
                                </div>
                 ...
                 <?php 
                    ...
                    $query_tampol = "SELECT * FROM dokter WHERE nm_dokter='$dokter_periksa'";
                    $sql_tampol = mysqli_query($conn, $query_tampol) or die ($conn->error);
                    $datas = mysqli_fetch_array($sql_tampol);
                    $jasa_dokter=$datas['jasa_dok'];
                   ?>


                        <div class="position-relative form-group col-md-2">
                            <label for="nama_pas" class="">Jasa DOkter</label>
                            <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" id="jasa_dok" name="jasa_dok" placeholder="masukkan Jasa Dokter" autofocus="" value="<?php echo $datas['jasa_dok']; ?>" >
                                </div>
...
<tr>
    ...
    <td colspan="8" align="right" bgcolor="#F5F5F5" ><strong><?php echo number_format ($tot_bayar+$totel_bayar+$totalBayar+$tot_bayar_lab+$tot_bayar_rad +$jasa_dokter); ?></strong></td>
</tr>
 ...
 <?php 
error_reporting(0);
      $query_tanpa = " SELECT tbl_transaksi.*, tbl_transaksi.no_daftar, tbl_transaksi.total_penjualan, tbl_transaksi.jml_uang, tbl_transaksi.jml_kembali,  tbl_daftarpasien.nama_pas, tbl_daftarpasien.asuransi_pas FROM tbl_transaksi

                  LEFT JOIN tbl_daftarpasien ON tbl_transaksi.no_daftar=tbl_daftarpasien.no_daftar  where tbl_transaksi.no_daftar ='$no_daftar' ";


      $sql_tanpa = mysqli_query($conn, $query_tanpa) or die ($conn->error);
      while($datang = mysqli_fetch_array($sql_tanpa)) {
...
$diskon =$datang['diskon'];
$total_afterdiskon =$datang['total_afterdiskon'];
     ...
     ?>
      ...
      <div class="form-group row">
            ...
            <div class="col-sm-4">
                                    <div class="input-group">
                                      ...
                                      <input  id="total_penjualan"  onkeyup="sum();" placeholder="" type="text" value="<?php echo  ($tot_bayar+$totel_bayar+$totalBayar+$tot_bayar_lab+$tot_bayar_rad +$jasa_dokter); ?>" class="form-control" placeholder="0">
                                <input  id="jasa_dok" placeholder="" type="hidden" value="<?php echo  $jasa_dokter; ?>" class="form-control" placeholder="0">
                                    </div>
          ...
          <label for="nomor_rm" class="col-sm-2 col-form-label" style="text-align: right;">Administrasi</label>
            <div class="col-sm-4">
                                    <div class="input-group">
                                      ...
                                      <input  id="administrasi"  onkeyup="sum();" placeholder="" type="number" value="<?php echo $adminis; ?>" class="form-control" placeholder="0">
                                    </div>
          </div>
          </div>

      <div class="form-group row">
            <label for="nama_pas" class="col-sm-2 col-form-label">Total </label>
            <div class="col-sm-4">
                    <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text" id="inputGroup-sizing-sm">Rp</span>
          </div>
          <input type="text" value="<?php echo $pembayar; ?>" class="form-control" id="total_bayar"   aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" >
        </div>

          </div>
          <label for="nomor_rm" class="col-sm-2 col-form-label" style="text-align: right;">Diskon</label>
            <div class="col-sm-4">
                                    <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text" id="inputGroup-sizing-sm">Rp</span>
          </div>
          <input  id="diskon"  onkeyup="sum();" placeholder="" type="number" value="<?php echo $diskon; ?>" class="form-control" placeholder="0">
                                    </div>
          </div>
          </div>
      ...
      <div class="form-group row">
            <label for="nama_pas" class="col-sm-2 col-form-label">Total Bayar</label>
            <div class="col-sm-4">
        <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text" id="inputGroup-sizing-sm">Rp</span>
          </div>
          <input type="text" value="<?php echo $total_afterdiskon; ?>" class="form-control" id="total_afterdiskon"   aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" >
        </div>
      ...
      <div class="form-group row">
          ...
          <label for="nomor_rm" class="col-sm-2 col-form-label" style="text-align: left;">Tunai</label>
            ...
            <div class="input-group">
              ...
              <input  id="jml_uang"  onkeyup="sum();" value="<?php echo $tunai; ?>" placeholder="" type="number" class="form-control" placeholder="0">
            </div>
          </div>
          </div>
     <div class="form-group row">
          ...
          <label for="nomor_rm" class="col-sm-2 col-form-label" style="text-align: left;">Kembalian </label>
            <div class="col-sm-4">
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" value="<?php echo $kembali; ?>" id="jml_kembali"  aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" >
                                    </div>
          </div>
          </div>
...
function sum() {
      var txtFirstNumberValue = document.getElementById('total_penjualan').value;
        ...
        var txtEmpatNumberValue = document.getElementById('diskon').value;
  var txtLimaNumberValue = document.getElementById('total_afterdiskon').value;

        var tambah=parseInt(txtFirstNumberValue)+parseInt(txtSecondNumberValue);
         document.getElementById('total_bayar').value = tambah;

        var dirkon=tambah-parseInt(txtEmpatNumberValue);
if (!isNaN(dirkon)) {
         document.getElementById('total_afterdiskon').value = dirkon;
}
      var result =  parseInt(txtThreeNumberValue)-dirkon;
...
function reset_form() {
  ...
  $("#btn_simpan").click(function() {
    ...
    var total_afterdiskon = $("#total_afterdiskon").val();
    ...
    if(kode=="") {
      ...
      $.ajax({
        type: "POST",
        url: "ajax/simpan_transaksi_igd.php",
        data: "total_penjualan="+total_penjualan+"&diskon="+diskon+"&total_afterdiskon="+total_afterdiskon+"&kode="+kode+"&jml_uang="+jml_uang+"&jml_kembali="+jml_kembali+"&administrasi="+administrasi+"&jasa_dok="+jasa_dok,
        success: function(hasil) {
            Swal.fire({
                  ...
                  if (ok.value) {
                    window.location='?page=kasir_igd' ;
                  }
                })
