...
<div class="page-content">
  <div class="row">
    <div class="col-6" id="judul"><h4>Data Transaksi Pasien IGD</h4></div>
...
<!--       <a href="?page=tambah_datatindakan">
  ...
  <div class="table-container">
    ...
    $no_daftar = @$_GET['id'];
      ...
      $query_tampil = " SELECT tbl_transaksi_igd.*, tbl_transaksi_igd.no_daftar, tbl_transaksi_igd.total_penjualan, tbl_transaksi_igd.jml_uang, tbl_transaksi_igd.jml_kembali,  tbl_daftarpasien_igd.nama_pas,tbl_daftarpasien_igd.asuransi_pas  FROM tbl_transaksi_igd

                  LEFT JOIN tbl_daftarpasien_igd ON tbl_transaksi_igd.no_daftar=tbl_daftarpasien_igd.no_daftar   ";
  ...
  <td><?php echo $data['total_afterdiskon']; ?></td>
    ...
    if(id==id_session) {
      ...
      Swal.fire({
            ...
            if (hapus.value) {
              $.ajax({
                type: "POST",
                url: "ajax/hapus.php?page=transaksi_igd",
                data: "id="+id,
                ...
                if (ok.value) {
                  window.location='?page=transaksi_igd';
                }
              })
                }
              })  
