...
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Billing Pasien IGD Per Bulan</h4></div>
...
?>
 ...
 <form role="form" class="form-horizontal" method="GET" action="laporan/lapor_biling_igd.php" target="_blank">
