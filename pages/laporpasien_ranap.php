...
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Pasien Ranap Per Bulan</h4></div>
...
?>
 ...
 <form role="form" class="form-horizontal" method="GET" action="laporan/cetak_pasien_ranap.php" target="_blank">
