...
<div class="page-content">
	<div class="row">
		<div class="col-6"><h4>Data Obat di Apotek</h4></div>
		<div class="col-6 text-right">
			...
			<a href="?page=tambah_dataobat_apotik"> 
...
<!-- 		            <th>Ket</th> -->
		    ...
		    <tbody>
		<?php 
			$query_tampil = "SELECT * FROM tbl_apotek ORDER BY nm_obat ASC";
...
<!-- 		 			<td><?php echo $data['stk_obat']; ?></td> -->
		 			      <td>
                              <?php if($data['stk_obat'] == '0'){?>
                        <button class="btn btn-sm btn-danger"> Kosong</button>
                      <?php }else{?>
                        <?php echo $data['stk_obat'];?>
                      <?php }?>
                    </td>
<!--                       <td><?php if($data['stk_obat'] <= '10') {
        echo "<a class='btn btn-sm btn-danger' >Hampir Habis</a>";}
        else {echo "<a class='btn btn-sm btn-success' >Stok Ready</a>"; }   ?></td> -->
