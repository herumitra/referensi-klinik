...
<div class="page-content">
  <div class="row">
    <div class="col-6"><h4>Laporan Pembelian Obat</h4></div>
...
?>
           ...
           <form role="form" class="form-horizontal" method="GET" action="laporan/cetak_pembelian_masuk.php" target="_blank">
