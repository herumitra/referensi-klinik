<?php 
 ...
 //    }
	...
	$query_pjl = "INSERT INTO tbl_pengobatan VALUES('$no_pengobatan', '$tgl_pengobatan','$no_rawat','$no_depo','$norem','$akai', '$total_penjualan','$status', '$id_pegawai')";
	...
	for($i = 0; $i < count($_POST['hidden_kdobat']); $i++) {
		...
		$query_pjldtl = "INSERT INTO tbl_pengobatandetail (no_pengobatan, kd_obat, expired, hrg_jual, jml_jual, sat_jual, akai, subtotal, jml_retur, no_depo) VALUES('$no_pengobatan', '$kd_obat', '$exp_obat', '$hrg_jual', '$jml_obat', '$sat_jual', '$akai','$subtotal','$jml_retur','$no_depo' )";
		mysqli_query($conn, $query_pjldtl) or die ($conn->error);
