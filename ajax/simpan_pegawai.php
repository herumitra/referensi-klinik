<?php 
	...
	if($hasil_validasi) {
		...
		if($posisi=="Admin") {
			...
			$pos = "KSR";
		} else if($posisi=="Rekam Medis") {
			$pos = "RMS";
		} else if($posisi=="Dokter") {
			$pos = "DOK";
		} else if($posisi=="Farmasi") {
			$pos = "FAR";
		} else if($posisi=="Analis") {
			$pos = "ANL";
		...
		$query = "INSERT INTO tbl_pegawai VALUES('$username', '$password', '$id', '$nama', '$poli', '$alamat', '$no_hp', '$jk', '$tgl_lahir', '$tgl_masuk', '$posisi')";
