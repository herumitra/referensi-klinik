<?php 
 ...
 //    }
	...
	$query_pjl = "INSERT INTO tbl_racikan VALUES('$no_pengobatan', '$tgl_pengobatan','$no_rawat','$nama_pasien','$norem','$akai', '$total_penjualan', '$id_pegawai')";
	...
	for($i = 0; $i < count($_POST['hidden_kdobat']); $i++) {
		...
		$query_pjldtl = "INSERT INTO tbl_racikandetail (no_pengobatan, kd_racik,  hrg_jual, jml_jual, sat_jual, akai, subtotal) VALUES('$no_pengobatan', '$kd_obat',  '$hrg_jual', '$jml_obat', '$sat_jual', '$akai','$subtotal' )";
		mysqli_query($conn, $query_pjldtl) or die ($conn->error);
