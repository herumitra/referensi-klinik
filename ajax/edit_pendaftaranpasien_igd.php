...
$nik = @mysqli_real_escape_string($conn, $_POST['nik']);
	...
	$query = "UPDATE tbl_daftarpasien_igd SET nama_pas='$nama_pas', nik='$nik', jk_pas='$jk_pas', lhr_pas='$tgl_lahir', tpt_lahir='$tpt_lahir', pekerjaan='$pekerjaan', asuransi_pas='$asuransi_pas', no_bpjs='$no_bpjs', keluhan='$keluhan',   nomor_rm='$nomor_rm', tinggi_badan='$tinggi_badan',berat_badan='$berat_badan', tekanan_darah='$tekanan_darah', temp='$temp', dokter='$dokter', goldarah='$goldarah', istirahat='$istirahat', tgl_istirahat='$tgl_istirahat' WHERE no_daftar = '$no_daftar'";
