<?php 
	...
	$tgl_stokawal = $_POST['tgl_stokawal'];
	$total_stokawal = $_POST['hidden_totalstokawal'];
	...
	if($cr_bayar=="Utang"){
		...
		$status = "Lunas";
		$tgl_lunas = $tgl_stokawal;
		$jth_tempo = "0000-00-00";
	}
	
	$id_pegawai =  $_SESSION['id_peg'];
	$query_pbl = "INSERT INTO tbl_stokawal (no_faktur, no_supplier, tgl_stokawal, cr_bayar, jth_tempo, total_stokawal, status_byr, tgl_lunas, id_peg) VALUES ('$no_faktur', '$no_supplier', '$tgl_stokawal', '$cr_bayar', '$jth_tempo', '$total_stokawal', '$status', '$tgl_lunas', '$id_pegawai')";
	...
	for($i = 0; $i < count($_POST["hidden_kdobat"]); $i++) {
		...
		$query_pbldtl = "INSERT INTO tbl_stokawaldetail (no_faktur, kd_obat, exp_obatbeli, hrg_beli, jml_beli, sat_beli, subtotal) VALUES ('$no_faktur', '$kd_obat', '$exp_obat', '$hrg_beli', '$jml_obat', '$sat_jual', '$subtotal')";
