<?php 
 ...
 //    }
	...
	$query_pjl = "INSERT INTO tbl_nama_racikan VALUES('$kd_racik', '$tgl_racik','$nama_racikan','$stk_obat','$akai', '$total_penjualan', '$tunai', '$kembali','$hrg_racikan', '$id_pegawai', '$status')";
