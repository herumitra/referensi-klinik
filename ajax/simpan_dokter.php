...
$query = "INSERT INTO dokter (kd_dokter, nm_dokter, jns_kelamin, tempat_lahir, tanggal_lahir, alamat, no_telepon, spesialisasi, tgl_input, jasa_dok) VALUES('$kode', '$nm_dokter', '$jk', '$tempat_lahir', '$tgl_lahir', '$alamat','$no_hp', '$spesialisasi', '$tgl_input', '$jasa_dok')";
