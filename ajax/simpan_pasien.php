...
*/
	...
	$query = "INSERT INTO tbl_pasien VALUES('$nomor_rm', '$nama_pas', '$jk','$tpt_lahir','$tgl_lahir', '$agama', '$status_nikah', '$pendidikan', '$pekerjaan', '$negara', '$goldarah', '$asuransi_pas', '$no_bpjs','$no_hp', '$alm_pas','$nomor_rm','$nik','$desa','$kec','$kab_kota','$provinsi','$poscode','$tgl_masuk','$id','$rma')";
