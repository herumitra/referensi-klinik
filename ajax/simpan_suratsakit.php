...
$tgl_selesai = @mysqli_real_escape_string($conn, $_POST['tgl_selesai']);
	...
	$query = "INSERT INTO tbl_suratsakit VALUES('$no_surat', '$no_daftar', '$tgl_surat','$kebutuhan','$nm_dokter','$nama_pas',  '$nomor_rm', '$tgl_lahir','$tgl_istirahat', '$tgl_selesai', '$id_pegawai')";
