 <?php 
	...
	$query_pbl = "INSERT INTO tbl_pengajuan_pembelian (no_faktur, no_supplier, tgl_pembelian, cr_bayar, jth_tempo, total_pembelian, status_byr, tgl_lunas, id_peg) VALUES ('$no_faktur', '$no_supplier', '$tgl_pembelian', '$cr_bayar', '$jth_tempo', '$total_pembelian', '$status', '$tgl_lunas', '$id_pegawai')";
	...
	for($i = 0; $i < count($_POST["hidden_kdobat"]); $i++) {
		...
		$query_pbldtl = "INSERT INTO tbl_pengajuandetail_pembelian (no_faktur, kd_obat, exp_obatbeli, hrg_beli, jml_beli, sat_beli, subtotal) VALUES ('$no_faktur', '$kd_obat', '$exp_obat', '$hrg_beli', '$jml_obat', '$sat_jual', '$subtotal')";
