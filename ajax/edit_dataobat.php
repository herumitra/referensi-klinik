<?php 
	...
	for($i=0; $i<$jml_a; $i++) {
		...
		$stok_s = $a_stok[$i];
		$stok = $stok + $stok_s;
		$query_stok = "UPDATE tbl_stokexpobat SET tgl_exp = '$exp_s' WHERE no_stok = '$nmr_stok'";
...
/*				$query_stok = "UPDATE tbl_stokexpobat SET tgl_exp = '$exp_s', stok = '$stok_s' WHERE no_stok = '$nmr_stok'";*/
	...
	$query = "UPDATE tbl_dataobat SET nm_obat='$nama', ktg_obat='$ktg', sat_obat='$satuan', hrg_obat='$harga_jual', hrgbeli_obat='$harga',  exp_obat='$exp_s', bnt_obat='$bentuk', minstk_obat='$min_stok' WHERE kd_obat = '$kode'";
