<?php 
	...
	if(@$_GET['page']=='laporan_stokawal'){
		...
		if($periode_lap == "hari_ini") {
			...
			$query = "SELECT * FROM tbl_stokawal INNER JOIN tbl_supplier ON tbl_stokawal.no_supplier = tbl_supplier.no_supp WHERE tbl_stokawal.tgl_stokawal = CURDATE() AND tbl_supplier.no_supp LIKE '$no_supp' AND tbl_stokawal.status_byr  LIKE '$status_byr' ORDER BY tbl_stokawal.tgl_stokawal ASC";
		} else if($periode_lap == "bulan_ini") {
			$ket_periode = date('F Y');
			$query = "SELECT * FROM tbl_stokawal INNER JOIN tbl_supplier ON tbl_stokawal.no_supplier = tbl_supplier.no_supp WHERE MONTH(tbl_stokawal.tgl_stokawal) = MONTH(CURDATE()) AND tbl_supplier.no_supp LIKE '$no_supp' AND tbl_stokawal.status_byr  LIKE '$status_byr' ORDER BY tbl_stokawal.tgl_stokawal ASC";
		} else if($periode_lap == "tahun_ini") {
			$ket_periode = "tahun ".date('Y');
			$query = "SELECT * FROM tbl_stokawal INNER JOIN tbl_supplier ON tbl_stokawal.no_supplier = tbl_supplier.no_supp WHERE YEAR(tbl_stokawal.tgl_stokawal) = YEAR(CURDATE()) AND tbl_supplier.no_supp LIKE '$no_supp' AND tbl_stokawal.status_byr  LIKE '$status_byr' ORDER BY tbl_stokawal.tgl_stokawal ASC";
			...
			if($cek_tgl == "yes") {
				...
				$query = "SELECT * FROM tbl_stokawal INNER JOIN tbl_supplier ON tbl_stokawal.no_supplier = tbl_supplier.no_supp WHERE (tbl_stokawal.tgl_stokawal BETWEEN '$tgl_awal' AND '$tgl_akhir') AND tbl_supplier.no_supp LIKE '$no_supp' AND tbl_stokawal.status_byr LIKE '$status_byr' ORDER BY tbl_stokawal.tgl_stokawal ASC";
			} else {
				$ket_periode = tgl_indo($tgl_awal);
				$query = "SELECT * FROM tbl_stokawal INNER JOIN tbl_supplier ON tbl_stokawal.no_supplier = tbl_supplier.no_supp WHERE tbl_stokawal.tgl_stokawal = '$tgl_awal' AND tbl_supplier.no_supp LIKE '$no_supp' AND tbl_stokawal.status_byr LIKE '$status_byr' ORDER BY tbl_stokawal.tgl_stokawal ASC";
			}
			...
			if($cek_bln == "yes") {
				...
				$query = "SELECT * FROM tbl_stokawal INNER JOIN tbl_supplier ON tbl_stokawal.no_supplier = tbl_supplier.no_supp WHERE (MONTH(tbl_stokawal.tgl_stokawal) = '$bulan1' AND YEAR(tbl_stokawal.tgl_stokawal) = '$tahunbulan1') AND tbl_supplier.no_supp LIKE '$no_supp' AND tbl_stokawal.status_byr  LIKE '$status_byr' ORDER BY tbl_stokawal.tgl_stokawal ASC";
			}
			...
			if($cek_thn == "yes") {
				...
				$query = "SELECT * FROM tbl_stokawal INNER JOIN tbl_supplier ON tbl_stokawal.no_supplier = tbl_supplier.no_supp WHERE (YEAR(tbl_stokawal.tgl_stokawal) BETWEEN '$per_tahun1' AND '$per_tahun2') AND tbl_supplier.no_supp LIKE '$no_supp' AND tbl_stokawal.status_byr LIKE '$status_byr' ORDER BY tbl_stokawal.tgl_stokawal ASC";
			} else {
				$ket_periode = "tahun ".$per_tahun1;
				$query = "SELECT * FROM tbl_stokawal INNER JOIN tbl_supplier ON tbl_stokawal.no_supplier = tbl_supplier.no_supp WHERE YEAR(tbl_stokawal.tgl_stokawal) = '$per_tahun1' AND tbl_supplier.no_supp LIKE '$no_supp' AND tbl_stokawal.status_byr LIKE '$status_byr' ORDER BY tbl_stokawal.tgl_stokawal ASC";
			}
		}
