...
/*		$query_stok = "SELECT stk_obat FROM tbl_obathematologi WHERE kd_obat = '$kd_obat'";
		...
		$query_estok = "UPDATE tbl_obathematologi SET stk_obat='$stok_baru' WHERE kd_obat='$kd_obat'";
		mysqli_query($conn, $query_estok) or die ($conn->error);*/


/*$query_stokhematologi = "UPDATE tbl_nama_hematologidetail SET stokini = stokini + ($jml_obat*jumlah) WHERE kd_hematologi='$kd_obat'";
mysqli_query($conn, $query_stokhematologi) or die ($conn->error);
*/

/*		$query_estok = "UPDATE tbl_hematologi SET stk_obat='$stok_baru' WHERE kd_hematologi='$kd_hematologi'";
		mysqli_query($conn, $query_estok) or die ($conn->error);
*/
