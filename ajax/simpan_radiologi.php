<?php 
	...
	$no_radiologi = $_POST['no_radiologi'];
	$tgl_radiologi = $_POST['tanggal_radiologi'];
 ...
 //    }
	...
	$query_tdk = "INSERT INTO tbl_radiologi VALUES('$no_radiologi', '$tgl_radiologi','$nm_dokter', '$no_daftar', '$norem', '$id_pegawai')";
	...
	for($i = 0; $i < count($_POST['hidden_kdradiologi']); $i++) {
		$kd_radiologi = $_POST['hidden_kdradiologi'][$i];
		$hrg_radiologi = $_POST['hidden_hrgradiologi'][$i];

		$query_pjldtl = "INSERT INTO tbl_radiologidetail (no_radiologi, kd_radiologi,  hrg_radiologi) VALUES('$no_radiologi', '$kd_radiologi',  '$hrg_radiologi')";
		mysqli_query($conn, $query_pjldtl) or die ($conn->error);
