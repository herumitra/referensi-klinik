<?php 
	...
	$query_pbl = "INSERT INTO tbl_pengajuan (no_permintaan, no_depo, tgl_permintaan, request_unit, total_permintaan, status, id_peg) VALUES ('$no_permintaan', '$no_depo', '$tgl_permintaan', '$request_unit', '$total_pembelian', '$status', '$id_pegawai')";
	...
	for($i = 0; $i < count($_POST["hidden_kdobat"]); $i++) {
		...
		$query_pbldtl = "INSERT INTO tbl_pengajuandetail (no_permintaan, kd_obat, exp_obatbeli, hrg_beli, jml_beli, sat_beli, subtotal, no_depo) VALUES ('$no_permintaan', '$kd_obat', '$exp_obat', '$hrg_beli', '$jml_obat', '$sat_jual', '$subtotal', '$no_depo')";
